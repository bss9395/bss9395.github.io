...
Shape {
    ...
    ShapePath {
        ...
        // 正上直线
        PathLine {
            x: shape.width - shape.radiusCorner[1]
            y: 0                                          + shape.borderWidth / 2
        }

        // 右上圆弧
        PathAngleArc {
            centerX: shape.width - shape.radiusCorner[1]
            centerY: shape.radiusCorner[1]
        ...
        // 右下圆弧
        PathAngleArc {
            centerX: shape.width - shape.radiusCorner[2]
            centerY: shape.height - shape.radiusCorner[2]
        ...
        // 左下圆弧
        PathAngleArc {
            centerX: shape.radiusCorner[3]
            centerY: shape.height - shape.radiusCorner[3]
        ...
        // 左上圆弧
        PathAngleArc {
            centerX: shape.radiusCorner[0]
            centerY: shape.radiusCorner[0]
