...
Depend.file = Depend/Depend_CONFIG.pro
Common.file = Common/Common_CONFIG.pro
Shared.file = Shared/Shared_CONFIG.pro
Plugin.file = Plugin/Plugin_CONFIG.pro
Employ.file = Employ/Employ_CONFIG.pro
