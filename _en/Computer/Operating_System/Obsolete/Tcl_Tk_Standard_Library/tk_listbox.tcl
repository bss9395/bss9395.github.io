...
# pack .listbox
# 
# .listbox insert end "Item1" "Item2" "Item3"
...
# pack .listbox
# 
# button .addBtn -text "Add Item" -command {
#     .listbox insert end "New Item"
# }
# button .deleteBtn -text "Delete Item" -command {
#     .listbox delete 0
# }
# pack .addBtn .deleteBtn
...
# pack .listbox
# 
# .listbox insert end "Item 1" "Item 2" "Item 3" "Item 4" "Item 5"
# 
# button .showSelectedBtn -text "Show Selected" -command {
# 	foreach index [.listbox curselection] {
# 		puts [.listbox get $index]
# 	}
# }
# pack .showSelectedBtn
...
# pack .listbox
# 
# .listbox insert end "Item 1" "Item 2" "Item 3" "Item 4"
# 
# bind .listbox <<ListboxSelect>> {
# 	puts "Selected: [.listbox get [.listbox curselection]]"
# }
...
set countrynames [list Argentina Australia Belgium Brazil Canada China Denmark Finland France Greece India Italy Japan Mexico Netherlands Norway Spain Sweden Switzerland]
array set populations [list ar 41000000 au 21179211 be 10584534 br 185971537 ca 33148682 cn 1323128240 dk 5457415 fi 5302000 fr 64102140 gr 11147000 in 1131043000 it 59206382 jp 127718000 mx 106535000 nl 16402414 no 4738085 es 45116894 se 9174082 ch 7508700]
...
bind .c.countries <<ListboxSelect>> showPopulation
bind .c.countries <Double-1> sendGift
...
for {set i 0} {$i < [llength $countrynames]} {incr i 2} {
	$::lbox itemconfigure $i -background #f0f0f0
}
