...
Title:     Git Commands
Revised:   2019-04-20 22:20:00 +08 @ China-Guangdong-ShenZhen +08
Authors:   BSS9395
Resources:
---
...
| :------------------------ | :----------------------------------------------------------- | :----------------------------------------------------------- |
| *`git filter-branch`*     | `--all --tree-filter`                                        | Rewrite branches.                                            |
...
| *`git log`*       | `-p -S` `-- --all --all-match --author --graph --decorate --format --grep --left-right --merges --no-merges --not --show-signature --since --stat --pretty=format: --until` | Show commit logs.                                            |
| :---------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
...
| *`git rm`*            | `--cached --force`      | Remove files from the working tree and from the index. |
