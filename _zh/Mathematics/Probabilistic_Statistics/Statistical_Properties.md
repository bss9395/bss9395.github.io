...
Topic:     概率统计
Title:     统计特性
Revised:   2018-06-03 21:43:00 +08 @ 中国-新疆-乌鲁木齐 +06
Authors:   璀璨星辰
Resources:
---
...
> $$
> \begin{alignedat}{3}
> \fbox{1}\Uparrow\quad & \sum_{(x_1, \cdots, x_m)} p (x_1, \cdots, x_m) = \sum_{(x_1, \cdots, x_m)} J (x_1, \cdots, x_m) - J (x_1^-, \cdots, x_m^-) \\
> \fbox{2}\Uparrow\quad & \int_{(x_1, \cdots, x_m)} p (x_1, \cdots, x_m) \mathrm{d} (x_1, \cdots, x_m) = \int_{(x_1, \cdots, x_m)} \dfrac{\partial^m J (x_1, \cdots, x_m)}{\partial x_1 \cdots \partial x_m} \mathrm{d} (x_1, \cdots, x_m) \\
> \Downarrow\quad       & \mathrm{Exp} [f (X_1, \cdots, X_m)] = \int_{(x_1, \cdots, x_m)} f (x_1, \cdots, x_m)  \cdot \mathrm{d} J (x_1, \cdots, x_m) \\
> \end{alignedat}
> $$
>
