...
Topic:     概率统计
Title:     中心极限定理
Revised:   2018-06-05 02:54:00 +08 @ 中国-新疆-乌鲁木齐 +06
Authors:   璀璨星辰
Resources:
---
...
> \fbox{1}\Uparrow\quad &&                                               \lim_{n \to +\infty} \sup_i \dfrac{|X_i - \mathrm{Exp} [X_i]|}{\sqrt{\sum_1^n \mathrm{Var} [X_n]}} \to 0 &\implies \lim_{n \to +\infty} \theta_{i 1} \rightrightarrows 0 \\
> \fbox{2}\Uparrow\quad &&                                                              \lim_{n \to +\infty} \sup_i \dfrac{\mathrm{Var} [X_i]}{\sum_1^n \mathrm{Var} [X_n]} \to 0 &\implies \lim_{n \to +\infty} \theta_{i 2} \rightrightarrows 0 \\
