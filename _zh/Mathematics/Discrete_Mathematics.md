...
Topic :  收敛极限
Title :  离散数学
Update:  2021-07-30T07:33:00+08@中国-广东-湛江+08
Author:  璀璨星辰
Link  :
---
...
全称量词$∀$表示对于每一个|对于所有的，存在量词$∃$表示存在某一个|存在一些的，特称量词$Ⅎ$表示对于特定的|存在唯一个|实际上存在。

集合$S$中元素的总个数为$\mathrm{Order}\langle S \rangle$，区域$I$中元素的总大小为$\mathrm{Field}\langle I \rangle$。
...
若集合$S$满足$\mathrm{ord} S = \mathrm{O}[ϰ_0]$，则称集合$S$为离散集，否则称集合$S$为紧致集，因此有限集为离散集。

自然数集/整数集/有理数集为离散集，无理数集/实数集/复数集为紧致集。

|                  $ℕ$                  | $⊊$  |                 $ℤ = ±ℕ$                  | $⊊$  |              $ℚ = ±\dfrac{ℕ}{ℕ}$               | $⫕$  |                    $𝔼 = ±{ℚ^{+} }^{ℚ^{+} }$                    |                 $𝔼 = ±{𝔼^{+} }^{𝔼^{+} }$                 | $=$  |      $ℝ = [0,1) × ±ℕ$       | $⊊$  |             $ℂ = ℝ ± τ · ℝ$              |
| :-----------------------------------: | :--: | :---------------------------------------: | :--: | :--------------------------------------------: | :--: | :----------------------------------------------------------: | :----------------------------------------------------: | :--: | :-------------------------: | :--: | :--------------------------------------: |
|                 离散                  |      |                   离散                    |      |                      紧致                      |      |                                                              |                          紧致                          |      |            连续             |      |                   连续                   |
|        $\mathrm{ord} ℕ ≡ ϰ_0$         | $<$  |   $\mathrm{ord} ℤ = 2 · \mathrm{ord} ℕ$   | $<$  |  $\mathrm{ord} ℚ ≤ 2 · \mathrm{ord}〈ℕ × ℕ〉$  | $≪$  | $\mathrm{ord} 𝔼 ≤ 2 · \mathrm{ord} 〈〈ℕ × ℕ〉× 〈ℕ × ℕ〉〉$ |    $\mathrm{ord} 𝔼 ≤ 2 · \mathrm{ord} 〈ℕ^{ℕ+1}〉$     | $=$  | $\mathrm{ord} ℝ ≡ 2 · ϰ_1$  | $<$  | $\mathrm{ord} ℂ = \mathrm{ord}〈ℝ × ℝ〉$ |
|        $\mathrm{Θ}[ϰ_0] = ϰ_0$        | $<$  |        $\mathrm{O}[ϰ_0] = 2 · ϰ_0$        | $<$  | $\mathrm{O}\left[ϰ_0^{2}\right] = 2 · ϰ_0^{2}$ | $≪$  |      $\mathrm{O}\left[ϰ_0^{2+2}\right] = 2 · ϰ_0^{2+2}$      | $\mathrm{O}\left[ϰ_0^{ϰ_0+1}\right] = 2 · ϰ_0^{ϰ_0+1}$ | $=$  | $\mathrm{O}[ϰ_1] = 2 · ϰ_1$ | $<$  |     $\mathrm{O}[ϰ_1^2] = 4 · ϰ_1^2$      |
| $\mathrm{fld} ℕ = \dfrac{ϰ_0^2}{ϰ_1}$ | $<$  | $\mathrm{fld} ℤ = 2 · \dfrac{ϰ_0^2}{ϰ_1}$ | $<$  |  $\mathrm{fld} ℚ ≤ 2 · \dfrac{ϰ_0^{3} }{ϰ_1}$   | $≪$  |                                                              |    $\mathrm{fld} 𝔼 ≤ 2 · \dfrac{ϰ_0^{ϰ_0+2} }{ϰ_1}$     | $=$  | $\mathrm{fld} ℝ = 2 · ϰ_0$  | $<$  |       $\mathrm{fld} ℂ = 4 · ϰ_0^2$       |
