...
|            $ℕ\backslash∞$             | $⊊$  |                 $ℤ = ±ℕ$                  | $⊊$  |           $ℚ = ±\dfrac{ℕ}{ℕ^{+}}$            | $⊊$  |                $𝔼 ≔ ±(ℚ^{+})^{ℚ^{+}}$                | $⫕$  |                   $𝔼 ≔ ±(𝔼^{+})^{𝔼^{+}}$                   | $⫓$  |      $ℝ = ±ℕ × [0,1)$       | $⊊$  |             $ℂ = ℝ ± τ · ℝ$              |
| :-----------------------------------: | :--: | :---------------------------------------: | :--: | :------------------------------------------: | :--: | :--------------------------------------------------: | :--: | :--------------------------------------------------------: | :--: | :-------------------------: | :--: | :--------------------------------------: |
|        $\mathrm{ord} ℕ ≡ ϰ_0$         | $<$  |   $\mathrm{ord} ℤ ≤ 2 · \mathrm{ord} ℕ$   | $<$  | $\mathrm{ord} ℚ ≤ 2 · \mathrm{ord}〈ℕ × ℕ〉$ | $<$  | $\mathrm{ord} 𝔼 ≤ 2 · \mathrm{ord}〈ℚ^{+} × ℚ^{+}〉$ | $≪$  |        $\mathrm{ord} \fbox{𝔼} ≤ 2 · ϰ_0^{2^{ϰ_0}}$         | $=$  | $\mathrm{ord} ℝ ≡ 2 · ϰ_1$  | $<$  | $\mathrm{ord} ℂ ≤ \mathrm{ord}〈ℝ × ℝ〉$ |
|        $\mathrm{Θ}[ϰ_0] ≈ ϰ_0$        | $<$  |        $\mathrm{O}[ϰ_0] ≈ 2 · ϰ_0$        | $<$  |       $\mathrm{O}[ϰ_0^2] ≈ 2 · ϰ_0^2$        | $<$  |    $\mathrm{O}\left[ϰ_0^{4}\right] ≈ 2 · ϰ_0^{4}$    | $≪$  | $\mathrm{O}\left[ϰ_0^{2^{ϰ_0}}\right] ≈ 2 · ϰ_0^{2^{ϰ_0}}$ | $=$  | $\mathrm{O}[ϰ_1] ≈ 2 · ϰ_1$ | $<$  |     $\mathrm{O}[ϰ_1^2] ≈ 4 · ϰ_1^2$      |
| $\mathrm{fld} ℕ = \dfrac{ϰ_0^2}{ϰ_1}$ | $<$  | $\mathrm{fld} ℤ = 2 · \dfrac{ϰ_0^2}{ϰ_1}$ | $<$  |  $\mathrm{fld} ℚ ≤ 2 · \dfrac{ϰ_0^3}{ϰ_1}$   | $<$  |      $\mathrm{fld} 𝔼 ≤ 2 · \dfrac{ϰ_0^5}{ϰ_1}$       | $≪$  |             $ϰ_0^{2^{ϰ_0}} ≈ \mathrm{Θ}[ϰ_1]$              | $=$  | $\mathrm{fld} ℝ = 2 · ϰ_0$  | $<$  |       $\mathrm{fld} ℂ = 4 · ϰ_0^2$       |
