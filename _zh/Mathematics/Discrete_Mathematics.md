...
Topic :  收敛极限
Title :  离散数学
Update:  2021-04-18T09:45:00+08@中国-广东-湛江+08
Author:  璀璨星辰
Link  :
---
...
若集合$S$满足$\mathrm{ord} S ≈ \mathrm{O}\left[ϰ_0^{ϰ_0+1}\right]$，则称集合$S$为离散集，否则称集合$S$为连续集，因此有限集为离散集。

自然数集/整数集/有理数集为离散集，无理数集/实数集/复数集为连续集。

|                  $ℕ$                  | $⊊$  |                 $ℤ = ±ℕ$                  | $⫕$  |                $ℚ = \dfrac{ℕ}{ℕ} × ±ℕ$                 | $⫕$  |      $𝔼 = \left[\dfrac{ℕ}{ℕ}\right]^{\frac{ℕ}{ℕ}} × ±ℕ$      | $=$  |      $ℝ = [0,1) × ±ℕ$       | $⊊$  |             $ℂ = ℝ ± τ · ℝ$              |
| :-----------------------------------: | :--: | :---------------------------------------: | :--: | :----------------------------------------------------: | :--: | :----------------------------------------------------------: | :--: | :-------------------------: | :--: | :--------------------------------------: |
|               离散/均匀               |      |                 离散/均匀                 |      |                       紧致/均匀                        |      |                          紧致/不均                           |      |          紧致/连续          |      |                紧致/连续                 |
