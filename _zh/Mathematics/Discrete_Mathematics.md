...
Topic :  收敛极限
Title :  离散数学
Update:  2021-04-16T14:27:00+08@中国-广东-湛江+08
Author:  璀璨星辰
Link  :
---
...
|        $\mathrm{Θ}[ϰ_0] ≈ ϰ_0$        | $<$  |        $\mathrm{O}[ϰ_0] ≈ 2 · ϰ_0$        | $<$  |        $\mathrm{O}[ϰ_0^3] ≈ 2 · ϰ_0^{3}$         | $<$  |            $\mathrm{O}[ϰ_0^5] ≈ 2 · ϰ_0^{5}$             |  $≪$  | $2 · ϰ_0^{2·ϰ_0}$ | $\mathrm{O}[ϰ_1] ≈ 2 · ϰ_1$ | $<$  |     $\mathrm{O}[ϰ_1^2] ≈ 4 · ϰ_1^2$      |
| $\mathrm{fld} ℕ = \dfrac{ϰ_0^2}{ϰ_1}$ | $<$  | $\mathrm{fld} ℤ = 2 · \dfrac{ϰ_0^2}{ϰ_1}$ | $<$  |    $\mathrm{fld} ℚ ≤ 2 · \dfrac{ϰ_0^4}{ϰ_1}$     | $<$  |        $\mathrm{fld} 𝔼 ≤ 2 · \dfrac{ϰ_0^6}{ϰ_1}$         |  $≪$  |                   | $\mathrm{fld} ℝ = 2 · ϰ_0$  | $<$  |       $\mathrm{fld} ℂ = 4 · ϰ_0^2$       |
