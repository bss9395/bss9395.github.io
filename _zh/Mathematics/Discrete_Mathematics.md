...
Topic :  收敛极限
Title :  离散数学
Update:  2021-04-17T15:01:00+08@中国-广东-湛江+08
Author:  璀璨星辰
Link  :
---
...
|                  $ℕ$                  | $⊊$  |                 $ℤ = ±ℕ$                  | $⫕$  |                $ℚ = \dfrac{ℕ}{ℕ} × ±ℕ$                 | $⫕$  |      $𝔼 = \left[\dfrac{ℕ}{ℕ}\right]^{\frac{ℕ}{ℕ}} × ±ℕ$      | $=$  |      $ℝ = [0,1) × ±ℕ$       | $⊊$  |             $ℂ = ℝ ± τ · ℝ$              |
| :-----------------------------------: | :--: | :---------------------------------------: | :--: | :----------------------------------------------------: | :--: | :----------------------------------------------------------: | :--: | :-------------------------: | :--: | :--------------------------------------: |
|        $\mathrm{ord} ℕ ≡ ϰ_0$         | $<$  |   $\mathrm{ord} ℤ = 2 · \mathrm{ord} ℕ$   | $≪$  |    $\mathrm{ord} ℚ ≤ 2 · \mathrm{ord}〈ℕ^{ℕ} × ℕ〉$    | $≪$  | $\mathrm{ord} 𝔼 ≤ 2 · \mathrm{ord}〈{(ℕ^{ℕ})}^{(ℕ^{ℕ})} × ℕ〉$ | $=$  | $\mathrm{ord} ℝ ≡ 2 · ϰ_1$  | $<$  | $\mathrm{ord} ℂ = \mathrm{ord}〈ℝ × ℝ〉$ |
|        $\mathrm{Θ}[ϰ_0] ≈ ϰ_0$        | $<$  |        $\mathrm{O}[ϰ_0] ≈ 2 · ϰ_0$        | $≪$  | $\mathrm{O}\left[ϰ_0^{ϰ_0+1}\right] ≈ 2 · ϰ_0^{ϰ_0+1}$ | $≪$  | $\mathrm{O}\left[ϰ_0^{ϰ_0^{ϰ_0+1}}\right] ≈ 2 · (ϰ_0^{ϰ_0})^{(ϰ_0^{ϰ_0})} = 2 · ϰ_0^{ϰ_0^{ϰ_0+1}}$ | $=$  | $\mathrm{O}[ϰ_1] ≈ 2 · ϰ_1$ | $<$  |     $\mathrm{O}[ϰ_1^2] ≈ 4 · ϰ_1^2$      |
| $\mathrm{fld} ℕ = \dfrac{ϰ_0^2}{ϰ_1}$ | $<$  | $\mathrm{fld} ℤ = 2 · \dfrac{ϰ_0^2}{ϰ_1}$ | $≪$  |    $\mathrm{fld} ℚ ≤ 2 · \dfrac{ϰ_0^{ϰ_0+2}}{ϰ_1}$     | $≪$  |   $\mathrm{fld} 𝔼 ≤ 2 · \dfrac{ϰ_0^{ϰ_0^{ϰ_0+1}+1}}{ϰ_1}$    | $=$  | $\mathrm{fld} ℝ = 2 · ϰ_0$  | $<$  |       $\mathrm{fld} ℂ = 4 · ϰ_0^2$       |
