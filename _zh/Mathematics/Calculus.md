...
| $\dfrac{\mathrm{d}}{\mathrm{d} x} f^{⇵}(x)$           | $\left[ \dfrac{\mathrm{d} x}{\mathrm{d} f^{⇵}(x)} \right]^{-1} \mathop{====}\limits^{x={'}f^{⇵}(y)} \left[ \dfrac{\mathrm{d}{'}f^{⇵}(y)}{\mathrm{d} y} \right]^{-1}$ | $\lim\limits_{x_t⇝x} \dfrac{f^{⇵}(x_t) - f^{⇵}(x)}{x_t - x} = \left[ \lim\limits_{x_t⇝x} \dfrac{x_t - x}{f^{⇵}(x_t) - f^{⇵}(x)} \right]^{-1} \mathop{====}\limits^{x={'}f^{⇵}(y)} \left[ \lim\limits_{x_t⇝x} \dfrac{{'}f^{⇵}(y_t) - {'}f^{⇵}(y)}{y_t - y} \right]^{-1} = \left[ \dfrac{\mathrm{d}{'}f^{⇵}(y)}{\mathrm{d}y} \right]^{-1}$ |
