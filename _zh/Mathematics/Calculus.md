...
Topic :  收敛极限
Title :  微积分
Update:  2021-04-21T01:47:00+08@中国-广东-湛江+08
Author:  璀璨星辰
Link  :
---
...
|       右导数 | ${^1}f(x_0^+) ≡ \dfrac{\mathrm{d}^1 f(x_0^+)}{\mathrm{d}^1 x}$ | $Ⅎx_0∈\fbox{X};∀ε>0;∃δ>0;∀x_t∈X; 0<x_t-x_0≤+δ ⇒ \left| \dfrac{f(x_t) - f(x_0)}{x_t - x_0} - {^1}f(x_0) \right|≤ε$ |                                                   |
| -----------: | :----------------------------------------------------------- | :----------------------------------------------------------- | :------------------------------------------------ |
|       左导数 | ${^1}f(x_0^-) ≡ \dfrac{\mathrm{d}^1 f(x_0^-)}{\mathrm{d}^1 x}$ | $Ⅎx_0∈\fbox{X};∀ε>0;∃δ>0;∀x_t∈X; -δ≤x_t-x_0<0 ⇒ \left| \dfrac{f(x_t) - f(x_0)}{x_t - x_0} - {^1}f(x_0) \right|≤ε$ |                                                   |
|       导数值 | ${^1}f(x_0) ≡ \dfrac{\mathrm{d}^1 f(x_0)}{\mathrm{d}^1 x}$   | $Ⅎx_0∈\fbox{X};∀ε>0;∃δ>0;∀x_t∈X; 0<|x_t-x_0|≤δ ⇒ \left| \dfrac{f(x_t) - f(x_0)}{x_t - x_0} - {^1}f(x_0) \right|≤ε$ |                                                   |
...
|              |                                                              |                                                              |                                                   |
|       导函数 | ${^1}f(x) ≡ \dfrac{\mathrm{d}^1 f(x)}{\mathrm{d}^1 x}$       | $∀x∈\fbox{X};∀ε>0;∃δ>0;∀x_t∈X; 0<|x_t - x|≤δ ⇒ \left| \dfrac{f(x_t) - f(x)}{x_t - x} - {^1}f(x) \right|≤ε$ |                                                   |
...
| $\dfrac{\mathrm{d}}{\mathrm{d} x}[f(x) + g(x)]$       | $\dfrac{\mathrm{d} f(x)}{\mathrm{d} x} + \dfrac{\mathrm{d} g(x)}{\mathrm{d} x}$ | $\lim\limits_{x_t⇝x} \dfrac{[f(x_t) + g(x_t)] - [f(x) + g(x)]}{x_t - x} = \lim\limits_{x⇝x} \dfrac{[f(x_t) - f(x)] + [g(x_t) - g(x)]}{x_t - x} = \dfrac{\mathrm{d} f(x)}{\mathrm{d} x} + \dfrac{\mathrm{d} g(x)}{\mathrm{d} x}$ |
| :---------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
| $\dfrac{\mathrm{d}}{\mathrm{d} x}[f(x) - g(x)]$       | $\dfrac{\mathrm{d}f(x)}{\mathrm{d}x} - \dfrac{\mathrm{d}g(x)}{\mathrm{d}x}$ | $\lim\limits_{x_t⇝x} \dfrac{[f(x_t) - g(x_t)] - [f(x) - g(x)]}{x_t - x} = \lim\limits_{x_t⇝x} \dfrac{[f(x_t) - f(x)] - [g(x_t) - g(x)]}{x_t - x} = \dfrac{\mathrm{d} f(x)}{\mathrm{d} x} - \dfrac{\mathrm{d} g(x)}{\mathrm{d} x}$ |
| $\dfrac{\mathrm{d}}{\mathrm{d}x}[f(x) · g(x)]$        | $\dfrac{\mathrm{d} f(x)}{\mathrm{d} x} · g(x) + f(x) · \dfrac{\mathrm{d} g(x)}{\mathrm{d} x}$ | $\lim\limits_{x_t⇝x} \dfrac{f(x_t) · g(x_t) - f(x) · g(x)}{x_t - x} = \lim\limits_{x_t⇝x} \dfrac{[f(x_t) - f(x)] · g(x_t) + f(x) · [g(x_t) - g(x)]}{x_t - x} = \dfrac{\mathrm{d} f(x)}{\mathrm{d} x} · g(x) + f(x) · \dfrac{\mathrm{d} g(x)}{\mathrm{d} x}$ |
| $\dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{f(x)}{g(x)}$ | $\dfrac{\dfrac{\mathrm{d}f(x)}{\mathrm{d} x} · g(x) - f(x) · \dfrac{\mathrm{d} g(x)}{\mathrm{d} x}}{g^2(x)}$ | $\lim\limits_{x_t⇝x} \dfrac{\dfrac{f(x_t)}{g(x_t)} - \dfrac{f(x)}{g(x)}}{x_t - x} = \lim\limits_{x_t⇝x} \dfrac{\dfrac{[f(x_t) - f(x)] · g(x)}{x_t - x} - \dfrac{f(x) · [g(x_t) - g(x)]}{x_t - x}}{g(x_t) · g(x)} \mathop{===}\limits^{g(x)≠0} \dfrac{\dfrac{\mathrm{d}f(x)}{\mathrm{d}x} · g(x) - f(x) · \dfrac{\mathrm{d} g(x)}{\mathrm{d} x}}{g^2(x)}$ |
| $\dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{1}{g(x)}$    | $\dfrac{-1}{g^2(x)} · \dfrac{\mathrm{d} g(x)}{\mathrm{d} x}$ |                                                              |
| $\dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{g(x)}{f(x)}$ | $-\dfrac{g^2(x)}{f^2(x)} · \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{f(x)}{g(x)}$ | $\dfrac{\mathrm{d}}{\mathrm{d} x} \left[ 1 \middle/ \dfrac{f(x)}{g(x)} \right] = -\dfrac{g^2(x)}{f^2(x)} · \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{f(x)}{g(x)}$ |
| $\dfrac{\mathrm{d}}{\mathrm{d} x} f(g(x))$            | $\dfrac{\mathrm{d} f(g(x))}{\mathrm{d} g(x)} · \dfrac{\mathrm{d} g(x)}{\mathrm{d} x} \mathop{===}\limits^{y=g(x)} \dfrac{\mathrm{d} f(y)}{\mathrm{d} y} · \dfrac{\mathrm{d} g(x)}{\mathrm{d} x}$ | $\lim\limits_{x_t⇝x} \dfrac{f(g(x_t)) - f(g(x))}{x_t - x} = \lim\limits_{x_t⇝x} \dfrac{f(g(x_t)) - f(g(x))}{g(x_t) - g(x)} · \dfrac{g(x_t) - g(x)}{x_t - x} = \dfrac{\mathrm{d} f(g(x))}{\mathrm{d} g(x)} · \dfrac{\mathrm{d} g(x)}{\mathrm{d} x} \mathop{===}\limits^{y=g(x)} \dfrac{\mathrm{d} f(y)}{\mathrm{d} y} · \dfrac{\mathrm{d} g(x)}{\mathrm{d} x}$ |
| $\dfrac{\mathrm{d}}{\mathrm{d} x} f^{⇵}(x)$           | $\left. 1 \middle/ \dfrac{\mathrm{d} x}{\mathrm{d} f^{⇵}(x)} \right. \mathop{====}\limits^{x={'}f^{⇵}(y)} \left. 1 \middle/ \dfrac{\mathrm{d}{'}f^{⇵}(y)}{\mathrm{d} y} \right.$ | $\lim\limits_{x_t⇝x} \dfrac{f^{⇵}(x_t) - f^{⇵}(x)}{x_t - x} = \left. 1 \middle/ \lim\limits_{x_t⇝x} \dfrac{x_t - x}{f^{⇵}(x_t) - f^{⇵}(x)} \right. \mathop{====}\limits^{x={'}f^{⇵}(y)} \left. 1 \middle/ \lim\limits_{x_t⇝x} \dfrac{{'}f^{⇵}(y_t) - {'}f^{⇵}(y)}{y_t - y} \right. = \left. 1 \middle/ \dfrac{\mathrm{d}{'}f^{⇵}(y)}{\mathrm{d}y} \right.$ |
