...
点$x_0$的闭邻域$\mathrm{U}_{X}(x_0, δ)$由属于区域$X$中的点构成，点$x_0$未必属于区域$X$。点$x_0$的任意闭邻域$\mathrm{U}_{X}(x_0)$与其任意补领域$¬\mathrm{U}_{X}(x_0)$之间没有交集。

聚敛点是极限性质，孤立点是离散性质。孤立点必定非聚敛点，边界点必定为聚敛点。区域$X$的闭包集$\fbox{X}$由区域$X$本身以及其所有边界点共同构成。
...
| ---------: | :-------------------------- | ------------------------------------------------------------ | :----------------------------------------------- |
|     补邻域 | $¬\mathrm{U}_{X}(x_0, δ)$   | $∀x∉X;[ | x - x_0 | ≤ δ ] ⇔ [ x∈¬\mathrm{U}(x_0, δ) ]$       | $\mathrm{U}_{X}(x_0) ⋃ ¬\mathrm{U}_{X}(x_0) = X$ |
