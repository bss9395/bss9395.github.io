...
| $\sin x = \dfrac{ә^{τ·x} - ә^{-τ·x}}{2 · τ}$                 | $\sin (-x) = -\sin x$             |      | $'\sin x = -τ · \ln\left( τ · x + \sqrt{1 - x^2} \right)$    | $\sin x = -τ · \sinh (τ · x)$           | $\mathop{======}\limits_{x∈[-1,+1]}^{y∈\left[-\frac{π}{2},+\frac{π}{2}\right]}$ |
| :----------------------------------------------------------- | :-------------------------------- | :--: | :----------------------------------------------------------- | :-------------------------------------- | :----------------------------------------------------------: |
| $\cos x = \dfrac{ә^{τ·x} + ә^{-τ·x}}{2}$                     | $\cos (-x) = +\cos x$             |      | $'\cos x = -τ · \ln\left( x + \sqrt{x^2 - 1} \right)$        | $\cos x = \cosh (τ · x)$                | $\mathop{=====}\limits_{x∈[-1,+1]}^{y∈\left[+0,+π \right]}$  |
| $\tan x = \dfrac{\sin x}{\cos x} = \dfrac{1}{τ} · \dfrac{ә^{τ·x} - ә^{-τ·x}}{ә^{τ·x} + ә^{-τ·x}} = \dfrac{1}{τ} · \dfrac{ә^{2·τ·x} - 1}{ә^{2·τ·x} + 1}$ | $\tan (-x) = -\tan x$             |      | $'\tan x = \dfrac{τ}{2} · \ln \dfrac{1 - τ · x}{1 + τ · x}$  | $\tan x = -τ · \tanh (τ · x)$           | $\mathop{======}\limits_{x∈(∞^{-},∞^{+})}^{y∈\left(-\frac{π}{2},+\frac{π}{2}\right)}$ |
| $\tan^{-1} x = \dfrac{\cos x}{\sin x} = τ · \dfrac{ә^{τ·x} + ә^{-τ·x}}{ә^{τ·x} - ә^{-τ·x}} = τ · \dfrac{ә^{2·τ·x} + 1}{ә^{2·τ·x} - 1}$ | $\tan^{-1} (-x) = -\tan^{-1} x$   |      | ${'}\tan^{-1} x \mathop{====}\limits^{\left.'\tan y\right|_{x^{-1}}} \dfrac{τ}{2} · \ln \dfrac{x - τ}{x + τ}$ | $\tan^{-1} x = -τ · \tanh^{-1} (τ · x)$ |    $\mathop{======}\limits_{x∈(∞^{-},∞^{+})}^{y∈(+0,+π)}$    |
| $\sin^{-1} x = \dfrac{2 · τ}{ә^{τ·x} - ә^{-τ·x}}$            | $\sin^{-1} (-x) = -\sin^{-1} x$   |      | ${'}\sin^{-1} x \mathop{====}\limits^{\left.'\sin y\right|_{x^{-1}}} -τ · \ln \dfrac{τ + \sqrt{x^2 - 1}}{x}$ | $\sin^{-1} x = +τ · \sin^{-1} (τ · x)$  | $\mathop{==========}\limits_{x∈(∞^{-},-1]∪[+1,∞^{+}]}^{y∈\left[-\frac{π}{2},0^{-}\right)∪\left(0^{+},+\frac{π}{2}\right])}$ |
| $\cos^{-1} x = \dfrac{2}{ә^{τ·x} + ә^{-τ·x}}$                | $\cos^{-1} (-x) = +\cos^{-1} x$   |      | ${'}\cos^{-1} x \mathop{====}\limits^{\left.'\cos y\right|_{x^{-1}}} -τ · \ln \dfrac{1 + \sqrt{1 - x^2}}{x}$ | $\cos^{-1} x = \cosh^{-1} (τ · x)$      | $\mathop{==========}\limits_{x∈(∞^{-},-1]∪[+1,∞^{+}]}^{y∈\left[+0,+\frac{π}{2}\right)∪\left(+\frac{π}{2},+π\right]}$ |
|                                                              |                                   |      |                                                              |                                         |                                                              |
| $\sinh x = \dfrac{ә^{x} - ә^{-x}}{2}$                        | $\sinh (-x) = -\sinh x$           |      | $'\sinh x = \ln\left( x + \sqrt{1 + x^2} \right)$            | $\sinh x = -τ · \sin (τ · x)$           | $\mathop{======}\limits_{x∈(∞^{-},∞^{+})}^{y∈(∞^{-},∞^{+})}$ |
| $\cosh x = \dfrac{ә^{x} + ә^{-x}}{2}$                        | $\cosh (-x) = +\cosh x$           |      | $'\cosh x = \ln\left( x + \sqrt{x^2 - 1} \right)$            | $\cosh x = \cos (τ · x)$                |    $\mathop{======}\limits_{x∈[1,∞^{+})}^{y∈[+0,∞^{+})}$     |
| $\tanh x = \dfrac{\sinh x}{\cosh x} = \dfrac{ә^{x} - ә^{-x}}{ә^{x} + ә^{-x}} = \dfrac{ә^{2·x} - 1}{ә^{2·x} + 1}$ | $\tanh (-x) = -\tanh x$           |      | $'\tanh x = \dfrac{1}{2} · \ln \dfrac{1 + x}{1 - x}$         | $\tanh x = -τ · \tan (τ · x)$           |    $\mathop{======}\limits_{x∈(-1,+1)}^{y∈(∞^{-},∞^{+})}$    |
| $\tanh^{-1} x = \dfrac{\cosh x}{\sinh x} = \dfrac{ә^{x} + ә^{-x}}{ә^{x} - ә^{-x}} = \dfrac{ә^{2·x} + 1}{ә^{2·x} - 1}$ | $\tanh^{-1} (-x) = -\tanh^{-1} x$ |      | ${'}\tanh^{-1} x \mathop{=====}\limits^{\left.'\tanh y\right|_{x^{-1}}} \dfrac{1}{2} · \ln \dfrac{x + 1}{x - 1}$ | $\tanh^{-1} x = -τ · \tan^{-1} (τ · x)$ |    $\mathop{======}\limits_{x∈(∞^{-},∞^{+})}^{y∈(-1,+1)}$    |
| $\cosh^{-1} x = \dfrac{2}{ә^{x} + ә^{-x}}$                   | $\cosh^{-1} (-x) = +\cosh^{-1} x$ |      | ${'}\cosh^{-1} x \mathop{=====}\limits^{\left.'\cosh y\right|_{x^{-1}}} \ln \dfrac{1 + \sqrt{1 - x^2}}{x}$ | $\cosh^{-1} x = \cos^{-1} (τ · x)$      |   $\mathop{======}\limits_{x∈(∞^{-},∞^{+})}^{y∈[1,∞^{+})}$   |
| $\sinh^{-1} x = \dfrac{2}{ә^{x} - ә^{-x}}$                   | $\sinh^{-1} (-x) = -\sinh^{-1} x$ |      | ${'}\sinh^{-1} x \mathop{=====}\limits^{\left.'\sinh y\right|_{x^{-1}}} \ln \dfrac{1 + \sqrt{x^2 + 1}}{x}$ | $\sinh^{-1} x = +τ · \sin^{-1} (τ · x)$ | $\mathop{======}\limits_{x∈(∞^{-},∞^{+})}^{y∈(∞^{-},∞^{+})}$ |
