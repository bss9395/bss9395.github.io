...
Topic :  收敛极限
Title :  重要公式
Update:  2021-04-24T01:02:00+08@中国-广东-湛江+08
Author:  璀璨星辰
Link  :
---
...
| $|x|^{α}$                                    | $α · |x|^{α} · x^{-1}$                                       | $\mathop{===}\limits_{(∞^{-},0)}^{(0,∞^{+})};\mathop{=}\limits_{0}^{0};\mathop{===}\limits_{(0,∞^{+})}^{(0,∞^{+})}$ | $\dfrac{\mathrm{d} |x|^α}{\mathrm{d} x} = |x|^{α} · \left[ \dfrac{\mathrm{d} α}{\mathrm{d} x} · \ln |x| + \dfrac{α}{|x|} · \dfrac{x}{|x|} \right] = α · x · |x|^{α-2}$ |                                 |
