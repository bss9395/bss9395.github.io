...
| $f (x)$                                      |                                                              | $\dfrac{\mathrm{d} f (x)}{\mathrm{d} x} \mathop{====}\limits_{y=f^{⇵}(x)}^{x={'}f^{⇵}(y)} \left. 1 \middle/ \dfrac{\mathrm{d} {'}f^{⇵}(y)}{\mathrm{d} y} \right.$ | $\lim\limits_{x_t⇝x} \dfrac{f(x_t) - f(x)}{x_t - x} \mathop{====}\limits^{x_t=x+Δx} \lim\limits_{Δx⇝0} \dfrac{f(x + Δx) - f(x)}{Δx}$ |
| :------------------------------------------- | :----------------------------------------------------------: | :----------------------------------------------------------- | :----------------------------------------------------------- |
| $\mathop{\log_β | x |}\limits_{0<β≠1}$       |                                                              | $\dfrac{1}{x · \ln β}$                                       | $\lim\limits_{x_t⇝x} \dfrac{\log_β x_t - \log_β x}{x_t - x} = \dfrac{1}{\ln β} · \lim\limits_{x_t⇝x} \ln \left( \dfrac{x_t}{x} \right)^{\frac{1}{x_t - x}} \mathop{====}\limits^{Δ=x_t-x} \dfrac{1}{\ln β} · \lim\limits_{Δ⇝0} \ln \left( 1 + \dfrac{Δ}{x} \right)^{\frac{x}{Δ} · \frac{1}{x}} ⇝ \dfrac{1}{x · \ln β}$ |
| $\ln | x |$                                  |                                                              | $\dfrac{1}{x}$                                               |                                                              |
| $\mathop{β^x}\limits_{0<β≠1}$                |                                                              | $β^x · \ln β$                                                | $\lim\limits_{x_t⇝x} \dfrac{β^{x_t} - β^{x}}{x_t - x} = β^{x} · \lim\limits_{x_t⇝x} \dfrac{β^{x_t - x} - 1}{x_t - x} \mathop{=====}\limits^{t=β^{x_t-x}-1} β^{x} · \lim\limits_{t⇝0} \dfrac{\ln β}{\ln (1 + t)^{\frac{1}{t}}} ⇝ β^{x} · \ln β$ |
| $ә^x$                                        |                                                              | $ә^x$                                                        |                                                              |
| $x^{ρ}$                                      |                                                              | $ρ · x^{ρ - 1}$                                              | $\dfrac{\mathrm{d}}{\mathrm{d} x} x^{ρ} = \dfrac{\mathrm{d}}{\mathrm{d} x} ә^{ρ · \ln x} = ә^{ρ · \ln x} · \dfrac{ρ}{x} = ρ · x^{ρ - 1}$ |
|                                              |                                                              |                                                              |                                                              |
| $\sin x = \dfrac{ә^{τ·x} - ә^{-τ·x}}{2 · τ}$ |         $\mathop{2·k·π}\limits_{(-π,+π)}^{[-1,+1]}$          | $+\cos x$                                                    | $\dfrac{\mathrm{d} \sin x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{ә^{τ·x} - ә^{-τ·x}}{2 · τ} = +\dfrac{ә^{τ·x} + ә^{-τ·x}}{2} = +\cos x$ |
| $\cos x = \dfrac{ә^{τ·x} + ә^{-τ·x}}{2}$     |         $\mathop{2·k·π}\limits_{(-π,+π)}^{[-1,+1]}$          | $-\sin x$                                                    | $\dfrac{\mathrm{d} \cos x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{ә^{τ·x} + ә^{-τ·x}}{2} = -\dfrac{ә^{τ·x} - ә^{-τ·x}}{2 · τ} = -\sin x$ |
| $\tan x = \dfrac{\sin x}{\cos x}$            | $\mathop{k·π}\limits_{(-\frac{π}{2},+\frac{π}{2})}^{(∞^{-},∞^{+})}$ | $+\cos^{-2} x$                                               | $\dfrac{\mathrm{d} \tan x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{\sin x}{\cos x} = \dfrac{+\cos^2 x + \sin^2 x}{\cos^2 x} = +\cos^{-2} x$ |
| $\tan^{-1} x$                                |        $\mathop{k·π}\limits_{(0,+π)}^{(∞^{-},∞^{+})}$        | $-\sin^{-2} x$                                               | $\dfrac{\mathrm{d} \tan^{-1} x}{\mathrm{d} x} = (-1) · \tan^{-2} x · \cos^{-2} x = - \sin^{-2} x$ |
| $\cos^{-1} x$                                | $\mathop{2·k·π}\limits_{(-\frac{π}{2},+\frac{π}{2})}^{[+1,∞^{+})};\mathop{2·k·π}\limits_{(+\frac{π}{2},\frac{3·π}{2})}^{(∞^{-},-1]}$ | $+\cos^{-2} x · \sin x$                                      | $\dfrac{\mathrm{d} \cos^{-1} x}{\mathrm{d} x} = (-1) · \cos^{-2} x · (-\sin x) = +\cos^{-2} x · \sin x$ |
| $\sin^{-1} x$                                | $\mathop{2·k·π}\limits_{(-π,0)}^{(∞^{-},-1]};\mathop{2·k·π}\limits_{(0,+π)}^{[+1,∞^{+}]}$ | $-\sin^{-2} x · \cos x$                                      | $\dfrac{\mathrm{d} \sin^{-1} x}{\mathrm{d} x} = (-1) · \sin^{-2} x · (+\cos x) = -\sin^{-2} x · \cos x$ |
|                                              |                                                              |                                                              |                                                              |
| ${'}\sin x$                                  | $\mathop{=====}\limits_{[-1,+1]}^{[-\frac{π}{2},+\frac{π}{2}]}$ | $\dfrac{+1}{\sqrt{1 - x^2}}$                                 | $\dfrac{\mathrm{d} {'}\sin x}{\mathrm{d} x} = \left.1 \middle/ \dfrac{\mathrm{d} \sin y}{\mathrm{d} y} \right. = +\dfrac{1}{\cos y} = +\dfrac{1}{\sqrt{1 - \sin^2 y}} = \dfrac{+1}{\sqrt{1 - x^2}}$ |
| ${'}\cos x$                                  |    $\mathop{====}\limits_{[-1,+1]}^{\left[+0,+π \right]}$    | $\dfrac{-1}{\sqrt{1 - x^2}}$                                 | $\dfrac{\mathrm{d} {'}\cos x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \cos y}{\mathrm{d} y} \right. = -\dfrac{1}{\sin y} = -\dfrac{1}{\sqrt{1 - \cos^2 y}} = \dfrac{-1}{\sqrt{1 - x^2}}$ |
| ${'}\tan x$                                  | $\mathop{=====}\limits_{(∞^{-},∞^{+})}^{(-\frac{π}{2},+\frac{π}{2})}$ | $\dfrac{+1}{1 + x^2}$                                        | $\dfrac{\mathrm{d} {'}\tan x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \tan y}{\mathrm{d} y} \right. = +\dfrac{1}{\cos^{-2} y} = \dfrac{1}{1 + \tan^2 y} = \dfrac{+1}{1 + x^2}$ |
| ${'}\tan^{-1} x$                             | $\mathop{====}\limits_{(∞^{-},0^{-})}^{(-\frac{π}{2},0^{-})};\mathop{====}\limits_{(0^{+},∞^{+})}^{(0^{+},+\frac{π}{2})}$ | $\dfrac{-1}{1 + x^2}$                                        | $\dfrac{\mathrm{d} {'}\tan^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \tan^{-1} y}{\mathrm{d} y} \right. = -\dfrac{1}{\sin^{-2} y} = -\dfrac{1}{1 + \tan^{-2} y} = \dfrac{-1}{1 + x^2}$ |
| ${'}\cos^{-1} x$                             | $\mathop{====}\limits_{(∞^{-},-1]}^{(+\frac{π}{2},+π]};\mathop{====}\limits_{[+1,∞^{+})}^{[+0,+\frac{π}{2})}$ | $\dfrac{+1}{|x| · \sqrt{x^2 - 1}}$                           | $\dfrac{\mathrm{d} {'}\cos^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \cos^{-1} y}{\mathrm{d} y} \right. = +\dfrac{1}{\cos^{-2} y · \sin y} = +\dfrac{1}{\cos^{-2} y · \sqrt{1 - \cos^2 y}} = \dfrac{+1}{|x| · \sqrt{x^2 - 1}}$ |
| ${'}\sin^{-1} x$                             | $\mathop{====}\limits_{(∞^{-},-1]}^{(0^{-},-\frac{π}{2}]};\mathop{====}\limits_{[+1,∞^{+})}^{[+\frac{π}{2},0^{+})}$ | $\dfrac{-1}{|x| · \sqrt{x^2 - 1}}$                           | $\dfrac{\mathrm{d} {'}\sin^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \sin^{-1} y}{\mathrm{d} y} \right. = -\dfrac{1}{\sin^{-2} y · \cos y} = -\dfrac{1}{\sin^{-2} y · \sqrt{1 - \sin^{2} y}} = \dfrac{-1}{|x| · \sqrt{x^2 - 1}}$ |
|                                              |                                                              |                                                              |                                                              |
| $\sinh x = \dfrac{ә^{x} - ә^{-x}}{2}$        |    $\mathop{====}\limits_{(∞^{-},∞^{+})}^{(∞^{-},∞^{+})}$    | $+\cosh x$                                                   | $\dfrac{\mathrm{d} \sinh x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{ә^{x} - ә^{-x}}{2} = \dfrac{ә^{x} + ә^{-x}}{2} = +\cosh x$ |
| $\cosh x = \dfrac{ә^{x} + ә^{-x}}{2}$        |     $\mathop{====}\limits_{(∞^{-},∞^{+})}^{[+1,∞^{+})}$      | $+\sinh x$                                                   | $\dfrac{\mathrm{d} \cosh x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{ә^{x} + ә^{-x}}{2} = \dfrac{ә^{x} - ә^{-x}}{2} = +\sinh x$ |
| $\tanh x = \dfrac{\sinh x}{\cosh x}$         |       $\mathop{====}\limits_{(∞^{-},∞^{+})}^{(-1,+1)}$       | $+\cosh^{-2} x$                                              | $\dfrac{\mathrm{d} \tanh x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{\sinh x}{\cosh x} = \dfrac{\cosh^2 x - \sinh^2 x}{\cosh^2 x} = +\cosh^{-2} x$ |
| $\tanh^{-1} x$                               | $\mathop{====}\limits_{(∞^{-},0^{-})}^{(∞^{-},-1)};\mathop{====}\limits_{(0^{+},∞^{+})}^{(+1,∞^{+})}$ | $-\sinh^{-2} x$                                              | $\dfrac{\mathrm{d} \tanh^{-1} x}{\mathrm{d} x} = (-1) · \tanh^{-2} x · (+\cosh^{-2} x) = -\sinh^{-2} x$ |
| $\cosh^{-1} x$                               |     $\mathop{====}\limits_{(∞^{-},∞^{+})}^{(0^{+},+1]}$      | $-\cosh^{-2} x · \sinh x$                                    | $\dfrac{\mathrm{d} \cosh^{-1} x}{\mathrm{d} x} = (-1) · \cosh^{-2} x · (+\sinh x) = -\cosh^{-2} x · \sinh x$ |
| $\sinh^{-1} x$                               | $\mathop{====}\limits_{(∞^{-},0^{-})}^{(∞^{-},0^{-})};\mathop{====}\limits_{(0^{+},∞^{+})}^{(0^{+},∞^{+})}$ | $-\sinh^{-2} x · \cosh x$                                    | $\dfrac{\mathrm{d} \sinh^{-1} x}{\mathrm{d} x} = (-1) · \sinh^{-2} x · (+\cosh x) = -\sinh^{-2} x · \cosh x$ |
|                                              |                                                              |                                                              |                                                              |
| ${'}\sinh x$                                 |    $\mathop{====}\limits_{(∞^{-},∞^{+})}^{(∞^{-},∞^{+})}$    | $\dfrac{+1}{\sqrt{x^2 + 1}}$                                 | $\dfrac{\mathrm{d} {'}\sinh x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \sinh y}{\mathrm{d} y} \right. = +\dfrac{1}{\cosh y} = +\dfrac{1}{\sqrt{\sinh^2 x + 1}} = \dfrac{+1}{\sqrt{x^2 + 1}}$ |
| ${'}\cosh x$                                 |       $\mathop{====}\limits_{[+1,∞^{+})}^{[+0,∞^{+})}$       | $\dfrac{+1}{\sqrt{x^2 - 1}}$                                 | $\dfrac{\mathrm{d} {'}\cosh x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d}\cosh y}{\mathrm{d} y} \right. = +\dfrac{1}{\sinh y} = +\dfrac{1}{\sqrt{\cosh^2 y - 1}} = \dfrac{+1}{\sqrt{x^2 - 1}}$ |
| ${'}\tanh x$                                 |       $\mathop{====}\limits_{(-1,+1)}^{(∞^{-},∞^{+})}$       | $\dfrac{+1}{1 - x^2}$                                        | $\dfrac{\mathrm{d} {'}\tanh x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \tanh y}{\mathrm{d} y} \right. = +\dfrac{1}{\cosh^{-2} y} = +\dfrac{1}{1 - \tanh^{2} y} = \dfrac{+1}{1 - x^2}$ |
| ${'}\tanh^{-1} x$                            | $\mathop{====}\limits_{(∞^{-},-1)}^{(∞^{-},0^{-})};\mathop{====}\limits_{(+1,∞^{+})}^{(0^{+},∞^{+})}$ | $\dfrac{+1}{1 - x^2}$                                        | $\dfrac{\mathrm{d} {'}\tanh^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \tanh^{-1} y}{\mathrm{d} y} \right. = -\dfrac{1}{\sinh^{-2} y} = -\dfrac{1}{\tanh^{-2} y - 1} = \dfrac{+1}{1 - x^{2}}$ |
| ${'}\cosh^{-1} x$                            |       $\mathop{====}\limits_{(0^{-},+1]}^{[0,∞^{+})}$        | $\dfrac{-1}{|x| · \sqrt{1 - x^2}}$                           | $\dfrac{\mathrm{d} {'}\cosh^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \cosh^{-1} y}{\mathrm{d} y} \right. = -\dfrac{1}{\cosh^{-2} y · \sinh y} = -\dfrac{1}{\cosh^{-2} y · \sqrt{\cosh^{2} y - 1}} = \dfrac{-1}{|x| · \sqrt{1 - x^2}}$ |
| ${'}\sinh^{-1} x$                            | $\mathop{====}\limits_{(∞^{-},0^{-})}^{(∞^{-},0^{-})};\mathop{====}\limits_{(0^{+},∞^{+})}^{(0^{+},∞^{+})}$ | $\dfrac{-1}{|x| · \sqrt{1 + x^2}}$                           | $\dfrac{\mathrm{d} {'}\sinh^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \sinh^{-1} y}{\mathrm{d} y} \right. = -\dfrac{1}{\sinh^{-2} y · \cosh y} = -\dfrac{1}{\sinh^{-2} y · \sqrt{\sinh^{2} y + 1}} = \dfrac{-1}{|x| · \sqrt{1 + x^2}}$ |
