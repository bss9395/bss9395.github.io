...
Topic :  收敛极限
Title :  重要公式
Update:  2021-04-23T19:57:00+08@中国-广东-湛江+08
Author:  璀璨星辰
Link  :
---
...
|                                              | $\dfrac{\mathrm{d} f(-x)}{\mathrm{d} x} \mathop{===}\limits^{t=-x} -\dfrac{\mathrm{d} f(t)}{\mathrm{d} t}$ |                                                              |                                                              | $t \mathop{==}\limits^{x<0} -x$ |
| :------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------: | :----------------------------------------------------------- | :------------------------------ |
| $f (x)$                                      | $\dfrac{\mathrm{d} {'}f^{⇵}(y)}{\mathrm{d} y} \mathop{====}\limits_{y=f^{⇵}(x)}^{x={'}f^{⇵}(y)} \left[ \dfrac{\mathrm{d} f (x)}{\mathrm{d} x} \right]^{-1}$ |               $\mathop{==}\limits_{X}^{f(X)}$                | $\lim\limits_{x_t⇝x} \dfrac{f(x_t) - f(x)}{x_t - x} \mathop{====}\limits^{x_t=x+Δx} \lim\limits_{Δx⇝0} \dfrac{f(x + Δx) - f(x)}{Δx}$ |                                 |
|                                              |                                                              |                                                              |                                                              |                                 |
| $|x|$                                        | $|x| · x^{-1}$                                               | $\mathop{===}\limits_{(∞^{-},0)}^{(0,∞^{+})};\mathop{=}\limits_{0}^{0};\mathop{===}\limits_{(0,∞^{+})}^{(0,∞^{+})}$ | $\lim\limits_{x_t⇝x>0} \dfrac{x_t - x}{x_t - x} ⇝ +1$        | $-1$                            |
...
| $|x|^{α}$                                    | $α · |x|^{α} · x^{-1}$                                       | $\mathop{===}\limits_{(∞^{-},0)}^{(0,∞^{+})};\mathop{=}\limits_{0}^{0};\mathop{===}\limits_{(0,∞^{+})}^{(0,∞^{+})}$ | $\dfrac{\mathrm{d} |x|^α}{\mathrm{d} x} = \dfrac{\mathrm{d} ә^{α · \ln |x|}}{\mathrm{d} x} = ә^{α·\ln |x|} · \dfrac{α}{x} = α · |x|^{α} · x^{-1}$ |                                 |
| $x^{α}$                                      | $α · x^{α - 1}$                                              | $\mathop{0<α}\limits_{(∞^{-},0)}^{(0,∞^{+})};\mathop{=}\limits_{0}^{0};\mathop{===}\limits_{(0,∞^{+})}^{(0,∞^{+})}$ | $\dfrac{\mathrm{d} x^{α}}{\mathrm{d} x} = \left[ \dfrac{\mathrm{d} |x^α|}{\mathrm{d} x^α} \right]^{-1} · \dfrac{\mathrm{d} |x|^α}{\mathrm{d} x} = [|x^{α}| · x^{-α}]^{-1} · α · |x|^{α} · x^{-1} = α · x^{α-1}$ |                                 |
|                                              |                                                              |                                                              |                                                              |                                 |
|                                              |                                                              |                                                              |                                                              |                                 |
| $\sin x = \dfrac{ә^{τ·x} - ә^{-τ·x}}{2 · τ}$ | $+\cos x$                                                    |         $\mathop{2·k·π}\limits_{(-π,+π)}^{[-1,+1]}$          | $\dfrac{\mathrm{d} \sin x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{ә^{τ·x} - ә^{-τ·x}}{2 · τ} = +\dfrac{ә^{τ·x} + ә^{-τ·x}}{2} = +\cos x$ |                                 |
| $\cos x = \dfrac{ә^{τ·x} + ә^{-τ·x}}{2}$     | $-\sin x$                                                    |         $\mathop{2·k·π}\limits_{(-π,+π)}^{[-1,+1]}$          | $\dfrac{\mathrm{d} \cos x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{ә^{τ·x} + ә^{-τ·x}}{2} = -\dfrac{ә^{τ·x} - ә^{-τ·x}}{2 · τ} = -\sin x$ |                                 |
