...
| $f (x)$                                                      | $\dfrac{\mathrm{d} f (x)}{\mathrm{d} x} = \left.1 \middle/ \dfrac{\mathrm{d x}}{\mathrm{d} f (x)} \right. = \left. 1 \middle/ \dfrac{\mathrm{d} {'}f^{⇵}(y)}{\mathrm{d} y} \right.$ | $\lim\limits_{x_t⇝x} \dfrac{f(x_t) - f(x)}{x_t - x}$         |
| :----------------------------------------------------------- | :----------------------------------------------------------- | :----------------------------------------------------------- |
...
|                                                              |                                                              |                                                              |
| $\sin x$                                                     | $+\cos x = +\sin \left( \dfrac{π}{2} - x \right) = +\sin \left( x + \dfrac{π}{2} \right)$ | $\lim\limits_{x_t⇝x} \dfrac{\sin x_t - \sin x}{x_t - x} = +\lim\limits_{x_t⇝x} \cos \dfrac{x_t + x}{2} · \lim\limits_{x_t⇝x} \dfrac{\sin \frac{x_t - x}{2}}{\frac{x_t - x}{2}} ⇝ +\cos x$ |
| $\cos x$                                                     | $-\sin x = -\cos \left( \dfrac{π}{2} - x \right) = +\cos \left( x + \dfrac{π}{2} \right)$ | $\lim\limits_{x_t⇝x} \dfrac{\cos x_t - \cos x}{x_t - x} = -\lim\limits_{x_t⇝x} \sin \dfrac{x_t + x}{2} · \lim\limits_{x_t⇝x} \dfrac{\sin \frac{x_t - x}{2}}{\frac{x_t - x}{2}} ⇝ -\sin x$ |
