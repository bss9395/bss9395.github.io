...
Topic :  收敛极限
Title :  重要公式
Update:  2021-04-22T01:57:00+08@中国-广东-湛江+08
Author:  璀璨星辰
Link  :
---
...
| $f (x)$                                      |                                                              | $\dfrac{\mathrm{d} f (x)}{\mathrm{d} x} = \left.1 \middle/ \dfrac{\mathrm{d x}}{\mathrm{d} f (x)} \right. \mathop{====}\limits^{x={'}f^{⇵}(y)} \left. 1 \middle/ \dfrac{\mathrm{d} {'}f^{⇵}(y)}{\mathrm{d} y} \right.$ | $\lim\limits_{x_t⇝x} \dfrac{f(x_t) - f(x)}{x_t - x} \mathop{====}\limits^{x_t=x+Δx} \lim\limits_{Δx⇝0} \dfrac{f(x + Δx) - f(x)}{Δx}$ |
| :------------------------------------------- | :----------------------------------------------------------: | :----------------------------------------------------------- | :----------------------------------------------------------- |
...
|                                              |                                                              |                                                              |                                                              |
| $\sin x = \dfrac{ә^{τ·x} - ә^{-τ·x}}{2 · τ}$ |                                                              | $+\cos x = +\sin \left( \dfrac{π}{2} - x \right) = \sin \left( x + \dfrac{π}{2} \right)$ | $\dfrac{\mathrm{d} \sin x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{ә^{τ·x} - ә^{-τ·x}}{2 · τ} = +\dfrac{ә^{τ·x} + ә^{-τ·x}}{2} = +\cos x$ |
| $\cos x = \dfrac{ә^{τ·x} + ә^{-τ·x}}{2}$     |                                                              | $-\sin x = -\cos \left( \dfrac{π}{2} - x \right) = \cos \left( x + \dfrac{π}{2} \right)$ | $\dfrac{\mathrm{d} \cos x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{ә^{τ·x} + ә^{-τ·x}}{2} = -\dfrac{ә^{τ·x} - ә^{-τ·x}}{2 · τ} = -\sin x$ |
| $\tan x = \dfrac{\sin x}{\cos x}$            |                                                              | $+\cos^{-2} x$                                               | $\dfrac{\mathrm{d} \tan x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{\sin x}{\cos x} = \dfrac{+\cos^2 x + \sin^2 x}{\cos^2 x} = +\cos^{-2} x$ |
| $\tan^{-1} x$                                |                                                              | $-\sin^{-2} x$                                               | $\dfrac{\mathrm{d} \tan^{-1} x}{\mathrm{d} x} = (-1) · \tan^{-2} x · \cos^{-2} x = - \sin^{-2} x$ |
| $\cos^{-1} x$                                |                                                              | $+\cos^{-2} x · \sin x$                                      | $\dfrac{\mathrm{d} \cos^{-1} x}{\mathrm{d} x} = (-1) · \cos^{-2} x · (-\sin x) = +\cos^{-2} x · \sin x$ |
| $\sin^{-1} x$                                |                                                              | $-\sin^{-2} x · \cos x$                                      | $\dfrac{\mathrm{d} \sin^{-1} x}{\mathrm{d} x} = (-1) · \sin^{-2} x · (+\cos x) = -\sin^{-2} x · \cos x$ |
|                                              |                                                              |                                                              |                                                              |
| ${'}\sin x$                                  | $\mathop{======}\limits_{x∈[-1,+1]}^{y∈\left[-\frac{π}{2},+\frac{π}{2}\right]}$ | $+\dfrac{1}{\sqrt{1 - x^2}}$                                 | $\dfrac{\mathrm{d} {'}\sin x}{\mathrm{d} x} = \left.1 \middle/ \dfrac{\mathrm{d} \sin y}{\mathrm{d} y} \right. = +\dfrac{1}{\cos y} = +\dfrac{1}{\sqrt{1 - \sin^2 y}} = +\dfrac{1}{\sqrt{1 - x^2}}$ |
| ${'}\cos x$                                  |       $\mathop{=====}\limits_{x∈[-1,+1]}^{y∈[+0,+π]}$        | $-\dfrac{1}{\sqrt{1 - x^2}}$                                 | $\dfrac{\mathrm{d} {'}\cos x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \cos y}{\mathrm{d} y} \right. = -\dfrac{1}{\sin y} = -\dfrac{1}{\sqrt{1 - \cos^2 y}} = -\dfrac{1}{\sqrt{1 - x^2}}$ |
| ${'}\tan x$                                  | $\mathop{======}\limits_{x∈(∞⁻,∞⁺)}^{y∈\left(-\frac{π}{2},+\frac{π}{2}\right)}$ | $+\dfrac{1}{1 + x^2}$                                        | $\dfrac{\mathrm{d} {'}\tan x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \tan y}{\mathrm{d} y} \right. = +\dfrac{1}{\cos^{-2} y} = \dfrac{1}{1 + \tan^2 y} = +\dfrac{1}{1 + x^2}$ |
| ${'}\tan^{-1} x$                             |       $\mathop{=====}\limits_{x∈(∞⁻,∞⁺)}^{y∈(+0,+π)}$        | $-\dfrac{1}{1 + x^2}$                                        | $\dfrac{\mathrm{d} {'}\tan^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \tan^{-1} y}{\mathrm{d} y} \right. = -\dfrac{1}{\sin^{-2} y} = -\dfrac{1}{1 + \tan^{-2} y} = -\dfrac{1}{1 + x^2}$ |
| ${'}\cos^{-1} x$                             | $\mathop{==========}\limits_{x∈(∞⁻,-1]∪[+1,∞⁺)}^{y∈\left[+0,+\frac{π}{2}\right)∪\left(+\frac{π}{2},+π\right]}$ | $+\dfrac{1}{|x| · \sqrt{x^2 - 1}}$                           | $\dfrac{\mathrm{d} {'}\cos^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \cos^{-1} y}{\mathrm{d} y} \right. = +\dfrac{1}{\cos^{-2} y · \sin y} = +\dfrac{1}{\cos^{-2} y · \sqrt{1 - \cos^2 y}} = +\dfrac{1}{|x| · \sqrt{x^2 - 1}}$ |
| ${'}\sin^{-1} x$                             | $\mathop{==========}\limits_{x∈(∞⁻,-1]∪[+1,∞⁺)}^{y∈\left[-\frac{π}{2},0^{-}\right)∪\left(0^{+},+\frac{π}{2}\right]}$ | $-\dfrac{1}{|x| · \sqrt{x^2 - 1}}$                           | $\dfrac{\mathrm{d} {'}\sin^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \sin^{-1} y}{\mathrm{d} y} \right. = -\dfrac{1}{\sin^{-2} y · \cos y} = -\dfrac{1}{\sin^{-2} y · \sqrt{1 - \sin^{2} y}} = -\dfrac{1}{|x| · \sqrt{x^2 - 1}}$ |
|                                              |                                                              |                                                              |                                                              |
| $\sinh x = \dfrac{ә^{x} - ә^{-x}}{2}$        |                                                              | $+\cosh x$                                                   | $\dfrac{\mathrm{d} \sinh x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{ә^{x} - ә^{-x}}{2} = \dfrac{ә^{x} + ә^{-x}}{2} = +\cosh x$ |
| $\cosh x = \dfrac{ә^{x} + ә^{-x}}{2}$        |                                                              | $+\sinh x$                                                   | $\dfrac{\mathrm{d} \cosh x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{ә^{x} + ә^{-x}}{2} = \dfrac{ә^{x} - ә^{-x}}{2} = +\sinh x$ |
| $\tanh x = \dfrac{\sinh x}{\cosh x}$         |                                                              | $+\cosh^{-2} x$                                              | $\dfrac{\mathrm{d} \tanh x}{\mathrm{d} x} = \dfrac{\mathrm{d}}{\mathrm{d} x} \dfrac{\sinh x}{\cosh x} = \dfrac{\cosh^2 x - \sinh^2 x}{\cosh^2 x} = +\cosh^{-2} x$ |
| $\tanh^{-1} x$                               |                                                              | $-\sinh^{-2} x$                                              | $\dfrac{\mathrm{d} \tanh^{-1} x}{\mathrm{d} x} = (-1) · \tanh^{-2} x · (+\cosh^{-2} x) = -\sinh^{-2} x$ |
| $\cosh^{-1} x$                               |                                                              | $-\cosh^{-2} x · \sinh x$                                    | $\dfrac{\mathrm{d} \cosh^{-1} x}{\mathrm{d} x} = (-1) · \cosh^{-2} x · (+\sinh x) = -\cosh^{-2} x · \sinh x$ |
| $\sinh^{-1} x$                               |                                                              | $-\sinh^{-2} x · \cosh x$                                    | $\dfrac{\mathrm{d} \sinh^{-1} x}{\mathrm{d} x} = (-1) · \sinh^{-2} x · (+\cosh x) = -\sinh^{-2} x · \cosh x$ |
|                                              |                                                              |                                                              |                                                              |
| ${'}\sinh x$                                 |                                                              | $+\dfrac{1}{\sqrt{x^2 + 1}}$                                 | $\dfrac{\mathrm{d} {'}\sinh x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \sinh y}{\mathrm{d} y} \right. = +\dfrac{1}{\cosh y} = +\dfrac{1}{\sqrt{\sinh^2 x + 1}} = +\dfrac{1}{\sqrt{x^2 + 1}}$ |
| ${'}\cosh x$                                 |                                                              | $+\dfrac{1}{\sqrt{x^2 - 1}}$                                 | $\dfrac{\mathrm{d} {'}\cosh x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d}\cosh y}{\mathrm{d} y} \right. = +\dfrac{1}{\sinh y} = +\dfrac{1}{\sqrt{\cosh^2 y - 1}} = +\dfrac{1}{\sqrt{x^2 - 1}}$ |
| ${'}\tanh x$                                 |                                                              | $+\dfrac{1}{1 - x^2}$                                        | $\dfrac{\mathrm{d} {'}\tanh x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \tanh y}{\mathrm{d} y} \right. = +\dfrac{1}{\cosh^{-2} y} = +\dfrac{1}{1 - \tanh^{2} y} = +\dfrac{1}{1 - x^2}$ |
| ${'}\tanh^{-1} x$                            |                                                              | $+\dfrac{1}{1 - x^2}$                                        | $\dfrac{\mathrm{d} {'}\tanh^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \tanh^{-1} y}{\mathrm{d} y} \right. = -\dfrac{1}{\sinh^{-2} y} = -\dfrac{1}{\tanh^{-2} y - 1} = +\dfrac{1}{1 - x^{2}}$ |
| ${'}\cosh^{-1} x$                            |                                                              | $-\dfrac{1}{|x| · \sqrt{1 - x^2}}$                           | $\dfrac{\mathrm{d} {'}\cosh^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \cosh^{-1} y}{\mathrm{d} y} \right. = -\dfrac{1}{\cosh^{-2} y · \sinh y} = -\dfrac{1}{\cosh^{-2} y · \sqrt{\cosh^{2} y - 1}} = -\dfrac{1}{|x| · \sqrt{1 - x^2}}$ |
| ${'}\sinh^{-1} x$                            |                                                              | $-\dfrac{1}{|x| · \sqrt{1 + x^2}}$                           | $\dfrac{\mathrm{d} {'}\sinh^{-1} x}{\mathrm{d} x} = \left. 1 \middle/ \dfrac{\mathrm{d} \sinh^{-1} y}{\mathrm{d} y} \right. = -\dfrac{1}{\sinh^{-2} y · \cosh y} = -\dfrac{1}{\sinh^{-2} y · \sqrt{\sinh^{2} y + 1}} = -\dfrac{1}{|x| · \sqrt{1 + x^2}}$ |
