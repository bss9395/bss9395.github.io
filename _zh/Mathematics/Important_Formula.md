...
| :----------------------------------------------------------- | :----------------------------------------------------------- | ------------------------------------------------- | ----------------------------------------- | :--------------------------------------- | :----------------------------------------------------------- | ---------------------------------------------------------- | ----------------------------------------------------------- |
| $\lim\limits_{x⇝0} \dfrac{\sin x}{x} \mathop{⇝}\limits_{x∈\left(-\frac{π}{2},+\frac{π}{2}\right)}^{\sin |x| ≤ |x| ≤ \tan |x|} 1$ | $\lim\limits_{n⇝+∞} \dfrac{n^α}{β^n} \mathop{⇝}\limits_{1<β}^{0<α} 0$ | $\lim\limits_{x⇝0} \mathop{β^x}\limits_{0<β} = 1$ | $\lim\limits_{x⇝0^+} x^{\frac{1}{x}} ⇝ 0$ | $\lim\limits_{x⇝+∞} x^{\frac{1}{x}} ⇝ 1$ | $\lim\limits_{x⇝±∞} \left( 1 + \dfrac{1}{x} \right)^{x} ⇝ ә$ | $\lim\limits_{n⇝+∞} \sqrt[n]{γ} \mathop{⇝}\limits^{0<γ} 1$ | $\lim\limits_{x⇝0^+} x^α · \ln x \mathop{⇝}\limits^{0<α} 0$ |
| $\lim\limits_{x⇝0} \dfrac{\log_{β} (1 + x)}{x} ⇝ \dfrac{1}{\ln β}$ | $\lim\limits_{n⇝+∞} \dfrac{β^n}{n!} \mathop{⇝}\limits^{1<β} 0$ |                                                   |                                           |                                          | $\lim\limits_{x⇝+∞} \mathop{β^{x}}\limits_{0<β} = \mathop{0}\limits_{0<β<1};\mathop{1}\limits_{β=1};\mathop{+∞}\limits_{1<β}$ |                                                            |                                                             |
| $\lim\limits_{x⇝0} \dfrac{β^x - 1}{x} ⇝ \ln β$               | $\lim\limits_{x⇝+∞} \dfrac{\ln x}{x^α} \mathop{⇝}\limits_{0<α} 0$ |                                                   |                                           |                                          |                                                              |                                                            |                                                             |
