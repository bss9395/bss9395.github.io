...
毕达哥拉斯学派企图用数来解释一切，不仅认为万物包含数，而且认为万物皆为数。第一次数学危机。
...
推论：有理数是稠密的，但非连续的。
例子：$有理数\dfrac{1}{1} < 无理数\sqrt{2} < 有理数\dfrac{2}{1}。直线上的坐标并非与有理数一一对应，即存在不是有理数的空缺。$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

| **运算**             | **$性质\mathbb{N} \subseteq \mathbb{Z} \subseteq \mathbb{Q} \subseteq \mathbb{R} \subseteq \mathbb{C}$** | **例子**                  | **满足**                                           |
| :------------------- | :----------------------------------------------------------- | :------------------------ | :------------------------------------------------- |
...
| *除法（除数不为零）* | `对整数运算不封闭，引入有理数，拓展成有理数。`               | $5 ÷ 3 = \dfrac{5}{3}$    | $\mathbb{Q} ÷ \mathbb{Q} \mapsto \mathbb{Q}$       |
