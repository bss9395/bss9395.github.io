...
Topic:     顺其自然
Title:     公理化人类社会
Revised:   2019-03-05 23:15:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
Resources:
---
...
概率P(A|B)：实体乙对实体甲的评分完毕，实体甲对于实体乙的信用； // 发生在实体乙遇见实体甲之后
...
时刻01
实体乙的实时信用为0.8000，实体乙对实体甲的评分为0.8000。
实体甲对于实体乙的信用更新为\dfrac{0.8000×0.2000}{0.8000×0.2000 + 0.8000×0.8000} = 0.2000；实体甲的信用之历史和为0.0000 + 0.2000 = 0.2000；
实体甲的实时信用为\dfrac{0.2000}{1} = 0.2000；
...
实体甲的实时信用为\dfrac{0.4308}{2} = 0.2154。
...
实体甲的实时信用为\dfrac{0.6170}{3} ≈ 0.2057。
