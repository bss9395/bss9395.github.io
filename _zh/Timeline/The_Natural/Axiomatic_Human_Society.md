...
《几何原本》集古希腊数学成就之大成，从少量一般公理和平面公设出发，在结合百余条直观定义的基础上，运用严格的推理规则来证明数百个命题，将整个几何体系层层递进推演而出，由此建立起第一个数学公理系统，被称为欧几里得公理系统。
...
《几何原本》中所选取的一般公理都十分基本，所选取的平面公设除第5条公设外都十分直观，这些一般公理和平面公设，是欧几里得在整理前人知识成果的基础上，加以归纳整理而成的。然而应当指出的是，《几何原本》所采用的推理证明方法，虽然构成完整的数学演绎体系，但却并非严格满足公理系统的基本性质。比如第4条平面公设，其实可以由其余一般公理与平面公设，以及定义经过推理得到。所有命题的证明要么直接引用一般公理与平面公设，要么引用已被证明的命题，此即相当于间接引用一般公理与平面公设。全书没有给出任何定理或者定律，不过这些已被证明的命题实际上等同于定理或者定律。
...
欧几里得公理系统的第5公设，无论在形式上还是内容上，均不同于其余一般公理与平面公设，反而像一个命题。因此自《几何原本》诞生之后，每个时代都有数学家研究这条平面公设，试图从其余一般公理与平面公设出发，找到证明这条公设的方法，但都归于失败。
...
欧几里德公理系统的缺陷直到1899年德国数学家希尔伯特在其《几何基础》出版时得到了完善。在这部名著中，希尔伯特成功地建立了欧几里德几何的完整、严谨的公理体系，即所谓的希尔伯特公理体系。这一体系的建立使欧氏几何成为一个逻辑结构非常完善而严谨的几何体系。也标志着欧氏几何完善工作的终结。
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Ⅰ 关联公理共8条：
Ⅰ1 对于两点A和B，恒有一直线a，它同A和B这两点的每一点相关联。
