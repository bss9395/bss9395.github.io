...
Topic:     顺其自然
Title:     公理化人类社会
Revised:   2019-03-05 18:00:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
Resources:
---
...
概率P(A)：公民甲的可信程度；
概率P(\bar{A})：公民甲的失信程度；
概率P(B|A)：当公民甲的信用更新时，公民乙对公民甲的评分； // 发生在公民乙遇见公民甲之时
概率P(B|\bar{A})：当公民甲的信用保持时，善意取为公民乙的信用； // 发生在公民乙遇见公民甲之前

示例01
公民甲的信用为0.8，公民乙的信用为0.7，公民乙对公民甲的评分为0.9。
P(A) = 0.8, P(\bar{A}) = 0.2;
P(B|A) = 0.9, P(B|\bar{A}) = 0.7;
P(A|B) = \dfrac{0.9×0.8}{0.9×0.8 + 0.7×0.2} ≈ 0.8372;

示例02
公民甲的信用为0.8，公民乙的信用为0.8，公民乙对公民甲的评分为0.8。
P(A) = 0.8, P(\bar{A}) = 0.2;
P(B|A) = 0.8, p(B|\bar{A}) = 0.8;
P(A|B) = \dfrac{0.8×0.8}{0.8×0.8 + 0.8×0.2} = 0.8;

示例03
公民甲的信用为1.0，公民乙的信用为0.8，公民乙对公民甲的评分为0.9。
P(A) = 1.0, P(\bar{A}) = 0.0;
P(B|A) = 0.9, P(B|\bar{A}) = 0.8;
P(A|B) = \dfrac{0.9×1.0}{0.9×1.0 + 0.8×0.0} = 1.0;

示例04
公民甲的信用为0.0，公民乙的信用为0.8，公民乙对公民甲的评分为0.2。
P(A) = 0.0, P(\bar{A}) = 1.0;
P(B|A) = 0.2, P(B|\bar{A}) = 0.8;
P(A|B) = \dfrac{0.2×0.0}{0.2×0.0 + 0.8×1.0} = 0.0;
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
