...
Topic:     顺其自然
Title:     公理化人类社会
Revised:   2019-01-12 23:56:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
Resources:
---
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
推论：在实数中有唯一加法零元$0$，有唯一乘法幺元$1$。
若在实数中有两个零元$0_1$与零元$0_2$，
则$0_1 = 0_1 + 0_2 = 0_2 + 0_1 = 0_2$。

推论：对于任意实数$x$，有唯一加法负元$(-x)$，有唯一乘法逆元$x^{-1}$。
若对于任意实数$x$，有两个负元$(-x)_1$和负元$(-x)_2$，
则$(-x)_1 = (-x)_1 + 0 = (-x)_1 + [x + (-x)_2] = [(-x)_1 + x] + (-x)_2 = 0 + (-x)_2 = (-x)_2 + 0 = (-x)_2$。

定义：减法$a - b = a + (-b)$，除法$a ÷ b = a × b^{-1}$。

推论：方程$x + a = b$有唯一解$x = b - a$，对于$a ≠ 0$方程$x × a= b$有唯一解$x = b ÷ a$。
$x + a = b \iff (x + a) - a = b - a \iff x + (a - a) = b - a \iff x = b - a$。
