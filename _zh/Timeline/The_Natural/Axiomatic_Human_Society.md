...
Topic:     顺其自然
Title:     公理化人类社会
Revised:   2019-01-16 08:05:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
Resources:
---
...
$有且仅有实数r=分割A|A'，要么是集合A中的最大数，要么是集合A'中的最小数。$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
在结构上，该书以几何学为模式。斯宾诺莎从八个定义和七个命题入手，从中演绎出若干形而上学-伦理学结论。即使我们可以对这些推论在严格的逻辑意义上的有效性提出质问，我们也无法怀疑这样的说法，即这部书代表了一个完整的/统一的哲学体系。
...
亚里士多德《物理学》中的原理：
凡运动着的事物必然都有推动者在推动着它运动。
惯性定律成立的参照系称为惯性参照系。
绝对空间，即最优越的参照系。

《自然哲学之数学原理》是牛顿一生当中最重要的科学著作，

/~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
重要定义摘录：
[质量] 物质的量是物质的度量，可由密度与体积共同求出。
[动量] 运动的量是运动的度量，可由速度与物质的量共同求出。
[惯性] 物质固有的力是一种起抵抗作用的力，大小与该物体相当，使之保持静止或匀速直线运动状态。
[外力] 外力是一种对物体的推动作用，使其改变静止的或匀速直线运动的状态。

重要附注摘录：
[绝对时间] 绝对的/真实的时间，自身均匀地流逝，与一切外在事物无关；相对的/表象的时间，是可感知和外在的对运动之延续的量度，它常被用以代替真实时间，如一小时/一天/一个月/一年。
[绝对空间] 其自身特性与一切外在事物无关，处处均匀，永不移动。相对空间是一些可以在绝对空间中运动的结构，或是对绝对空间的量度，我们通过它与物体的相对位置感知它；它一般被当做不可移动空间，如地表以下/大气中或天空中的空间，都是以其与地球的相互关系确定的。绝对空间与相对空间在形状与大小上相同，但在数值上并不总是相同。例如，地球在运动，大气的空间相对于地球总是不变的，但在一个时刻大气通过绝对空间的一部分，而在另一时刻又通过绝对空间的另一部分，因此，在绝对的意义上看，它是连续变化。
...
[运动] 绝对运动是物体由一个绝对处所迁移到另一个绝对处所；相对运动是由一个相对处所迁移到另一个相对处所。

牛顿运动三大定律：
[牛顿第一定律/惯性定律] 物体总是保持静止或者匀速直线运动状态，除非有外力迫使其改变运动状态。// 如果没有外力作用，物体将以恒定速度运动下去，力不是维持物体运动的原因，而是使物体运动状态发生改变的原因。

$\vec{F} = 0 \iff \vec{v} = const$

[牛顿第二定律/加速度定律] 物体运动的变化率正比于合外力，变化的方向沿合外力作用的切线方向。$\vec{F} = m \vec{a} = \dfrac{\mathrm{d}}{\mathrm{d} t} (m \vec{v})$ // 力是产生加速度的原因。// 第二定律还具有完备性，即只要精确地给定某一时刻物体的位置以及速度，就能完全确定物体过去和未来的运动状态，拉普拉斯决定论。//这里所说的决定也意味着第二定律的关系式，即力的表示式中不涉及任何随即或不可预测的成分。完备性也要求当初始条件有微小的变化后，物体随后的运动状态与初始条件未变化时的运动状态相比仅有很小的差别，这实际是所谓运动的稳定性。然而，大量存在的问题是，确定性的系统其初始条件无论有多么微小的改变，其在足够长时间之后的运动就会失之毫厘，谬以千里，具有非常复杂的难以预测的行为，也就是系统的行为敏感地依赖于初值，在这种意义上我们说系统的运动具有随机性。在实际问题中，由于测量精度的限制，初始条件也总是仅有有限的精度。上述随机性具有普遍性，它是与系统中包含非线性密切相关的，即描述系统演化的动力学微分方程是非线性方程，这种随机性也称为内禀随机性。

[牛顿第三定律/反作用力定律] 每一种作用都有一个相等的反作用；或者，两个物体间的相互作用总是相等的，而且指向相反。// 物体之间的作用总是相互的，作用力与反作用力沿同一直线，大小相等方向相反。//现代物理学表明，物体之间的相互作用是以有限速度光速传播的。相互作用存在时间延迟性，因而一般而言，牛顿第三定律是不成立的。但是，如果相互作用的传递时间在所研究的问题中可以忽略不计，此时牛顿第三定律适用。

作用力与反作用力分别施加在互相作用两个物体上，互相依存，同时产生与消亡。

$\vec{F}_{1 \to 2} = \vec{F}_{1 \gets 2}$

第三定律不涉及运动，不要求参照系。
超距作用。
作用力与反作用力的性质相同
作用力与反作用力作用在两个物体上，永远不会相互抵消。

[力独立叠加定律]

重要推论摘录：
[力的合成] 物体同时受两个力作用时，其运动将沿平行四边形对角线进行，所用时间等于而立分别沿两个边所需。
[力的分解] 任何两个斜向力AC和CD复合成一直线力AD；反之，任何一直线力AD可分解为两个斜向力AC和CD；这种复合与分解已在力学上充分证实。

定义：
[惯性参照系] 在绝对静止空间中的力学运动定律由牛顿给出，相对这个空间静止或者作匀速直线运动的坐标系称为惯性参考系。// 惯性定律假定了惯性参照系的存在，惯性参考系实际上是不存在的。// 取以太阳系中心为原点/各坐标轴指向不动的“恒星的坐标系作为惯性参考系，精度就很高了。对于大部分工程技术问题，可以取固连于地球的坐标系为惯性参考系。

//如果我们选择这样一个参照系，即以太阳中心为原点，以指向任一恒星的直线为坐标轴，那么选择这样一个参考系，即以太阳为原点，以指向任一恒星的直线为坐标轴，那么所观测到的许多天文现象，都和根据牛顿运动定律和万有引力定律推出的结论较好地符合，所以这个参考系是精确度很高的惯性参考系。实验又表明，地球上的物体相对于地球的运动并不完全遵守牛顿运动定律，所以地球不是惯性参考系。这种偏差比较微小，我们常常可以把地球看做近似程度相当好的惯性参照系。
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
经典力学基本原理
[经典相对性原理] 在惯性参照系中，力学定律具有相同的形式。// 任何力学实验都不能区分静止或匀速运动的惯性参照系。// 力学的所有定律和方程不依赖于具体的惯性参考系的选择。
// 经典力学的相对性原理在宏观/低速的范围内，是与实验结果相一致的。
// 经典力学认为空间只是物质运动的场所，是与其中的物质完全无关而独立存在的，并且是永恒不变的/绝对静止的。空间的量度与惯性系无关，是绝对不变的，时间也是与物质运动无关的，而在永恒地/均匀地流逝着，时间是绝对的。

1905年，爱因斯坦在《论电体的电动力学》中，摒弃了以太假说合绝对参考系的假设，提出了两条狭义相对论的基本原理：

狭义相对论基本原理
[狭义相对性原理] 在惯性参照系中，物理定律具有相同的形式，所有惯性参照系对物体运动的描述都是等效的。//任何物理实验都不能区分静止或作匀速直线运动的惯性参照系。
[光速恒定性原理] 在惯性参照系中，真空中的光速恒定为常数。 //与光源或观测者的运动无关，不依赖于惯性系的选择。//矛盾

运用洛伦兹变换，可以得到许多与我们日常生活经验大相径庭的/令人惊奇的重要结论，两点之间的距离或者物体的长度随进行量度的惯性系的不同而不同，某一过程所经历的时间也随惯性系而异。以及动量与速度的关系和质能关系等等。

// 基于狭义相对论基本原理，需要寻找一组新的时间空间坐标变换关系，该变换关系应当满足两个条件：

01 满足光速不变原理和狭义相对性原理这两条基本假设；
02 当质点速度远小于真空中的光速时，新的变换关系应能使伽利略变换重新成立。

1905年爱因斯坦建立狭义相对论以后，狭义相对论只适用于惯性参照系，通常我们以地球作为惯性系，然而地球有公转和自转，所以从严格意义上并不是惯性系，近似惯性系。为了将非惯性系包含在相对论里面，

广义相对论基本原理
[广义相对性原理] 在任何参照系中，物理定律具有相同的形式。
[加速度等效原理] 在任何参照系中，引力与惯性力在局域等效。

广义相对论预言，引力场中光线的弯曲。
引力红移导致光信号向长波方向移动，由于引力作用导致波长向长波方向移动的现象。
黑洞，如果一个星体的密度非常巨大，它的引力也是非常巨大，以致在某一半径（常称为临界半径）内任何物体甚至是电磁波都不能从它的引力作用下逃逸出来。
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

狭义相对论效应
01 运动的钟表比静止的钟表走得慢，爱因斯坦延缓，时间延缓，钟慢效应。
02 运动的尺子比静止的尺子缩得短，尺缩效应，洛伦兹收缩。


爱因斯坦在提出狭义相对论以后，不久就感到这个理论存在一个严重的缺陷是承认惯性系的特殊地位。狭义相对论和经典力学有共同之处，即均承认惯性系的特殊地位。

对电动力学的研究产生了狭义相对论，对万有引力的研究产生了广义相对论。
