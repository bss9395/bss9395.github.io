...
04 [万有引力定律] 两质点间存在普适引力，大小正比于两质点质量的乘积，而反比于两质点距离的平方，方向沿两质点的连线。$\vec{F}_{1 \to 2} = - G \dfrac{m_1 m_2}{r_{1 \to 2}} \vec{r}_{1 \to 2} = -\vec{F}_{1 \gets 2}$
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
