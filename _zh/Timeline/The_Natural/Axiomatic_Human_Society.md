...
Topic:     顺其自然
Title:     公理化人类社会
Revised:   2019-01-02 03:48:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
Resources:
---
...
公理系统这个概念最初源自于数学证明，可人为划分成逻辑公理系统和非逻辑公理系统，一个典型的公理系统由五大部分构成：
...
公理系统特别是逻辑公理系统同样可能存在循环论证，但无论如何，一个合格的公理系统必须至少满足三大基本性质：
...
任何一个足够严谨的公理系统都不该断然凭空臆造，实际上人们通常在总结大量已有经验知识的基础上，将至关重要但并非准确无疑的现象归纳整理成公理，再逐步补充缺失之处，最终加工成完整的公理系统。公理系统的弱自洽性与弱独立性是相当基本的要求，若采用步步为营的构建方法，弱完备性也不难满足。根据后验主义中正确概率极大便可当作真理这一观点，若公理系统始终从未出现而且极有可能不会出现矛盾，则可认为该公理系统满足强自洽性，除非悖论被发现。为检验公理系统的强独立性，一种方法是构造新公理系统，将强独立性可疑的公理取相悖形式代入，并且保持其余公理不变。若新公理系统满足强自洽性，则原公理系统满足强独立性。否则原可疑的公理不满足强独立性，但不必定被其余公理推导出。公理系统的强完备性往往难以检验更难以满足，因此必要时可将强完备性人为当作公理之一，以确保在所有可考虑的结论都满足强自洽性和强独立性的情形下，人为忽略那些未知的情况。
