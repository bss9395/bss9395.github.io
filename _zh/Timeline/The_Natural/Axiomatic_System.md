...
宇宙中无处不是能量与物质，宏观物质都由大量微观粒子组成，微观粒子处于永不停息的无规则热运动状态中。虽然组成宏观物体的单个微观粒子其运动状态是杂乱无章的，但大量微观粒子遵从特定的概率统计规律性，宏观物质的性质将由微观粒子的状态决定，这正是热力学系统所研究的内容。从某种程度上来说，人类社会可类比于热力学系统。
...
热量是能量的一种，因此对于仅考虑热量与做功的热力学系统而言，绝热的热力学系统就是孤立的热力学系统，反之亦然。
...
若气体分子①②③④完全相同，则其在隔舱A与隔舱B中共有$5$种宏观状态，这些宏观状态所出现的概率分别为$\dfrac{1}{16}, \dfrac{1}{16}, \dfrac{4}{16}, \dfrac{4}{16}, \dfrac{6}{16}$，相对应于混乱程度由低到高所出现的概率分别为$\dfrac{2}{16}, \dfrac{8}{16}, \dfrac{6}{16}$。现考虑隔舱A中有$N$个完全相同的气体分子，隔板B中没有任何气体分子，当隔板被抽掉后，$N$个气体分子将做自由膨胀充满整个绝热容器，其在隔舱A与隔舱B中共有$2^N$中微观状态，每种微观状态所出现的概率均为$\dfrac{1}{2^N}$，这意味着所有气体分子全部退回到隔舱A或者全部退回到隔舱B的概率为$\dfrac{2}{2^N}$，当$N​$很大时这个概率是如此之小，以致于实际上不会发生，因此这是个不可逆过程。在绝热容器中做自由膨胀的气体分子，最终将均匀充满整个容器而达到平衡态，也就是整个热力学系统在宏观上的无序程度将达到最大，而这有很大概率会发生。热力学第二定律即是说，在孤立系统处于平衡态时，系统的熵趋于最大值，即系统无序程度达到最大。

![width:360px;](figures/Axiomatic_Human_Society/Maxwell's_Demon.svg)
