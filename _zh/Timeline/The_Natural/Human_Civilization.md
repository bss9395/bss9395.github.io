...
Topic:     顺其自然
Title:     人类文明
Revised:   2018-08-29 18:02:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
...
能够永久保留在人们的记忆或者机器的存储器当中的记录是有限的，人们不可能也不必要获取可无限进行的逻辑推理所得到的全部推论，于是当仅有少量前提和逻辑规则是已知的状况下，我们无法即刻断定无穷远处的未来是否可预测。一系列逻辑推理并非死不可一条路走到底，也可能在某阶段形成首尾衔接的推理系统，所有封闭循环的推理系统都是自洽的，但不必然就是正确的，逻辑推理系统一旦陷入错误的死循环亦或者死胡同，基本上都无药可救。常见情形下的逻辑推理从人为给定的前提开始，但并非任何原初前提都是经过推理得到的推论，这就意味着存在不是推论的原初前提，那些原初前提由不证自明的公理组成，其正确性被公认为是理所当然的。一个自洽的公理化系统，将从少量不证自明的公理出发，通过一组合乎逻辑的推理规则，得到该公理化系统中所有的推论，得不到该公理化系统外任何的推论，因而是封闭的。同一个公理化系统之内，要么步步为赢，要么一错再错。不同的公理化系统之间，要么嵌套包含而上下兼容，要么互相排斥而没有交集。
