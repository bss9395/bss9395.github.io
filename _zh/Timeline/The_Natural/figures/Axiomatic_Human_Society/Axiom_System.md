...
# 复数公理系统，共20个（未验证的猜想）
∀r∈ℂ; ∀s∈ℂ; ∀t∈ℂ; ∀β∈ℂ; ∃0∈ℂ; ∃-r∈ℂ; ∃1∈ℂ; ∃r⁻¹≠0∈ℂ; ∃rt∈ℂ;
## 加运算公理，共4个
[加法有零元] r + { 0} = r
[加法有负元] r + {-r} = 0
[加法结合律] r + (s + t) = (r + s) + t
...
## 拓扑距公理，共3个
[满足正则性] [|r| =  0 ] ↔ [r = 0]                                  ⇒ |0| = 0
[满足度量性] [|r| = |s|] ↔ [s = r] ∨ [s = -r]                       ⇒ |r| = |-r|
[满足三角性] |r + s| ≤ |r| + |s|                                    ⇒ s = -r; 0 ≤ |r|
## 线性序公理，共5个
[满足拓扑序] [|r| < |s|] ⊕ [|s| ≤ |r|]
[满足不等性] [|r| < |s|] ↔ [|r| ≤ |s|] ∧ [|r| ≠ |s|]
[满足传递性] [|r| < |s|] ∧ [|s| < |t|] → [|r| < |t|]
...
## 连续性性公理，共1个
[满足连续性] [|r - s| < |t - s|] → [|r - s| < |rt - s| < |t - s|]   ⇒ r = s; [0 < |t - r|] → [0 < |rt - r| < |t - r|]
```

于2020年08月17日 13:46:00 +08 在湛江 +08
