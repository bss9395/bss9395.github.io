...
Topic:     顺其自然
Title:     公理系统
Revised:   2019-02-08 18:00:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
Resources:
---
...
宇宙中无处不是能量与物质，宏观物质都由大量微观粒子组成，微观粒子处于永不停息的无规则热运动状态中。虽然组成宏观物质的单个微观粒子其运动状态是杂乱无章的，但大量微观粒子会遵从特定的概率统计规律性，而且微观粒子的数目越多，概率统计规律性的准确度就越高，宏观物质的性质将由微观粒子的状态决定，这正是热力学系统所研究的内容。从某种程度上来说，人类社会可类比于热力学系统。

![width:360px;](figures/Axiomatic_Human_Society/Thermodynamic_System@Wikipedia.svg)

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
孤立系统：系统完全不与外界交换能量或物质。
封闭系统：系统与外界交换能量但不交换物质。
开放系统：系统与外界既交换能量也交换物质。
绝热系统：系统完全不与外界交换热量或物质。
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

热量与功都是能量的不同形式，因此对于仅考虑热量传递与做功的热力学系统而言，绝热且不对外做功的热力学系统就是孤立的热力学系统，反之亦然。
...
当蒸汽机被大量推广应用以后，不少人试图设计制造各种不需要能源就可做有用功的机器。比如从海水中吸取热量将之完全转化成有用功，但不需要向比海水温度低的热源放热，而海水中的热量取之不尽用之不竭。这类被被称为第二类永动机的机器并不违反能量守恒定律，若第二类永动机被制造成功，则将解决人类现有的以及未来的能源危机。

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
热力学第零定律/热量平衡定律：
若两个物体均与第三物体处于热量平衡状态，则这两个物体处于热量平衡状态。
相互达到热量平衡状态的物体有相同的温度。

热力学第一定律/能量守恒定律：
能量在转化与传递的过程中必保持总量不变，既不会凭空产生也不会无故消失。
第一类永动机，即不消耗任何能量而自动做有用功的机器，不可能存在。

热力学第二定律/热量传递定律：
热量不能自发地从低温物体传递到高温物体。
第二类永动机，即将单一热源全自动转化为有用功的机器，不可能存在。
...
熵（系统的无序程度）增加原理：
热力学系统任何绝热非对外做功过程的熵只增不减，
绝热可逆过程的熵不变，绝热非可逆过程的熵增加。
孤立的热力学系统总是朝熵最大的平衡态自发进行。
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

热力学系统中普遍存在着不可逆现象，当给定系统处于非平衡态时，系统总会自动从非平衡态向平衡态过渡，当给定系统处于平衡态时，系统却不会自动从平衡态向非平衡态过渡。比如热量可以自发地从高温物体传递到低温物体，但热量不能自发地从低温物体传递到高温物体。又比如气体会自动地向真空作自由膨胀，但充满真空的气体不可能自动地收缩回来。大量事实说明，热力学系统中的宏观过程具有方向性，能够自发地朝特定方向进行，但不能自发地朝相反方向进行。

对于孤立的热力学系统的无序程度，可考虑在绝热容器中做自由膨胀的气体分子。设想用隔板将绝热容器分隔成体积相等的隔舱A与隔舱B，且隔舱A中有若干气体分子，隔舱B中没有任何气体分子。对于隔舱A中的任一气体分子a，在隔板未被抽掉前，气体分子a仅在隔舱A中做无规则运动，当隔板被抽掉后，气体分子a可在隔舱A与隔舱B中做无规则运动，任意时刻气体分子a在隔舱A与隔舱B中的概率相等，均为$\dfrac{1}{2}$。考虑隔舱A中有$4$个气体分子，隔舱B中没有任何气体分子，当隔板被抽掉后，$4$个气体分子将做自由膨胀充满整个绝热容器，其在隔舱A与隔舱B中共有$2^4=16$种微观状态，每种微观状态的概率均为$\dfrac{1}{16}​$。

$$
\begin{array}{c|c|c|cccc|cccc|cccccc|c}
\hline
隔舱A    &      & ①②③④ &  ①  &  ②  &  ③  &  ④  & ②③④ & ①③④ & ①②④ & ①②③ & ①②  & ①③  & ①④  & ②③  & ②④  & ③④  & 总   \\
隔舱B    & ①②③④ &      & ②③④ & ①③④ & ①②④ & ①②③ &  ①  &  ②  &  ③  &  ④  & ③④  & ②④  & ②③  & ①④  & ①③  & ①②  & 计   \\
\hline
宏观状态 & 0:4  & 4:0  & 1:3 & 1:3 & 1:3 & 1:3 & 3:1 & 3:1 & 3:1 & 3:1 & 2:2 & 2:2 & 2:2 & 2:2 & 2:2 & 2:2 & 16种 \\
无序程度 & 低   & 低   & 中  & 中  & 中  & 中  & 中  & 中  & 中  & 中  & 高  & 高  & 高  & 高  & 高  & 高         \\
\hline
\end{array}
$$

若4个气体分子完全相同，则其在隔舱A与隔舱B中共有$5$种宏观状态，这些宏观状态的概率分别为$\dfrac{1}{16}, \dfrac{1}{16}, \dfrac{4}{16}, \dfrac{4}{16}, \dfrac{6}{16}$，相对应于混乱程度由低到高的概率分别为$\dfrac{2}{16}, \dfrac{8}{16}, \dfrac{6}{16}$。现考虑隔舱A中有$N$个完全相同的气体分子，隔板B中没有任何气体分子，当隔板被抽掉后，$N$个气体分子将做自由膨胀充满整个绝热容器，其在隔舱A与隔舱B中共有$2^N$中微观状态，每种微观状态所出现的概率均为$\dfrac{1}{2^N}$，这意味着所有气体分子全部退回到隔舱A或者隔舱B的概率为$\dfrac{2}{2^N}$，当$N$很大时这个概率是如此之小，以致于实际上不会发生，因此这是个不可逆过程。在绝热容器中做自由膨胀的气体分子，最终将均匀充满整个容器而达到平衡态，也就是整个热力学系统在宏观上的无序程度将达到最大，而这有很大概率会发生。熵增加原理的概率统计意义即是说，孤立的热力学系统总是自发地，由概率小的宏观状态向概率大的宏观状态进行，亦即由包含微观状态数目少的宏观状态向包含微观状态数目多的宏观状态进行。

![width:360px;](figures/Axiomatic_Human_Society/Maxwell's_Demon@SongShuHui.svg)

熵增加原理表明，热力学系统中任何涉及热量传递的自发过程都具有方向性。1867年，麦克斯韦（英语：James Clerk Maxwell，1831年~1879年）为说明自然界中可能存在着违悖熵增加原理的能量控制机制，他假想在绝热容器中做自由膨胀运动的气体分子，隔板上存在若干阀门，由被称为麦克斯韦妖的小妖精把守着。起初隔舱A与隔舱B的温度相同，都由速度分布相同的气体分子的组成。小妖精通过控制阀门，仅允许高速气体分子由隔舱A单向进入隔舱B，以及仅允许低速气体分子由隔舱B单向进入隔舱A。当达到平衡状态时，隔舱A将充满低速气体分子而温度较低，隔舱B将充满高速气体分子而温度较高，整个容器中气体分子的无序程度将大大降低，即系统的熵将大大减少，同时借助于隔舱A与隔舱B之间的温度差，可制作成第二类永动机。麦克斯韦的本意是想借此说明，熵增加原理描述的是大量微观粒子的概率统计规律，热量不能自发地从低温物体传递到高温物体，而单个微观粒子却很有可能自发地从低温物体流向高温物体。麦克斯韦妖的存在，显然违背熵增加原理以及热力学第二定律，这只虚构的小妖精曾经让物理学家们伤透脑筋。1956年，布里渊（法语：Léon Nicolas Brillouin，1889年~1969年）在其专著《科学与信息论》中从信息论的角度分析麦克斯韦妖。由于容器是密闭的孤立系统，小妖精处于绝对黑体之中，无法分辨清楚气体分子的速度和方向，也就无法决定是否打开阀门。若要判断气体分子的运动状态信息，就需要额外的光源提供光，光子被气体分子散射后为小妖精的眼睛所吸收。但这种有外部能量输入的系统并非孤立的热力学系统，因此也就不满足熵增加原理的前提条件。

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
热力学系统对现行人类社会的些许启示：
01 人类，大量在永不停息做无规则热运动的微观粒子。
02 国家，封闭的或开放的热力学系统。
03 政府，把持着阀门的麦克斯韦妖。
04 权力，热量不能自发地从低温物体传递到高温物体，单个微观粒子可以自发地从低温物体传递到高温物体。
05 统治者与被统治者，高温热源与低温热源。
06 货币总量持续增加，熵增加原理。
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
