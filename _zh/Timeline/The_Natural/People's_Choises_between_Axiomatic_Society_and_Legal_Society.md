...
## 对数分配定理
1[对数还原律]    logᵦ(αʳ) = r × logᵦ(α)
2[对数还原律]           r = β^(logᵦ(r))
3[对数链乘律]     logᵦ(r) = logᵦ(γ) × logᵧ(r)
4[对数变基律]     logᵧ(r) = logᵦ(r) / logᵦ(γ)
5[对数分配律] logᵦ(r × s) = logᵦ(r) + logᵦ(s)
6[对数互换律] r^(logᵦ(s)) = s^(logᵦ(r))
7[]
...
1满足恒等性 ⇒       αʳ = αʳ
 对数还原律 ⇒       αʳ = (β^(logᵦ(α)))ʳ
 指数乘运算 ⇒       αʳ = β^(r × logᵦ(α))
1由对数定义 ⇒ logᵦ(αʳ) = r × logᵦ(α)
2满足恒等性 ⇒  logᵦ(r) = logᵦ(r)
2由对数定义 ⇒        r = β^(logᵦ(r))
3满足恒等性 ⇒  logᵦ(r) = logᵦ(r)
 对数还原律 ⇒  logᵦ(r) = logᵦ(γ^(logᵧ(r)))
 对数还原律 ⇒  logᵦ(r) = logᵧ(r) × logᵦ(γ)
3乘法交换律 ⇒  logᵦ(r) = logᵦ(γ) × logᵧ(r)
4由除法定义 ⇒  logᵧ(r) = logᵦ(r) / logᵦ(γ)

5满足恒等性 ⇒ logᵦ(r × s) = logᵦ(r × s)
...
5乘法有幺元 ⇒ logᵦ(r × s) = logᵦ(r) + logᵦ(s)
6满足恒等性 ⇒ r^(logᵦ(s)) = r^(logᵦ(s))
 对数还原律 ⇒ r^(logᵦ(s)) = (β^(logᵦ(r)))^(logᵦ(s))
 指数交换律 ⇒ r^(logᵦ(s)) = (β^(logᵦ(s)))^(logᵦ(r))
6对数还原律 ⇒ r^(logᵦ(s)) = s^(logᵦ(r))
7
