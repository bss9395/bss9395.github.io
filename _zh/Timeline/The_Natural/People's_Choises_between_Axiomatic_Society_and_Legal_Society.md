...
∀E,𝟘→E→𝟙; ∀F,𝟘→F→𝟙;
## 归约公理，共3个
[下确界] [0 = ℙ(E)] ↔ [E = 𝟘]    概率为0的事件为没戏事件，没戏事件的概率为0
[正则性]  0 ≤ ℙ(E)               任意事件的概率大于或等于0
[上确界] [1 = ℙ(E)] ↔ [E = 𝟙]    概率为1的事件为必然事件，必然事件的概率为1
## 容斥公理，共1个
...
1[对立性] ℙ(E | F) + ℙ(¬E | F) = 1
2[正则性] 0 ≤ ℙ(E) ≤ 1
3[可加性] ℙ(E₁ ∨ E₂ | F) ≤ ℙ(E₁ | F) + ℙ(E₂ | F)
4[互斥性] [E₁ ∧ E₂ = 𝟘] ↔ [ℙ(E₁ ∨ E₂ | F) = ℙ(E₁ | F) + ℙ(E₂ | F)]
5[排斥性]     [E₁ → E₂] → [ℙ(E₂ ⊖ E₁ | F) = ℙ(E₂ | F) - ℙ(E₁ | F)]
6[单调性]     [E₁ → E₂] → [ℙ(E₁ | F) ≤ ℙ(E₂ | F)]
7[排斥性] ℙ(E₁ ⊖ E₂) = ℙ(E₁) - ℙ(E₁ ∧ E₂)
