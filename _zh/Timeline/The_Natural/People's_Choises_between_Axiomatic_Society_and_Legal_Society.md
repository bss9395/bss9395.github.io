...
# 条件概率
条件概率P(E₂ | E₁)，表示在事件E₁发生的条件下，事件E₂发生的概率。
     P(E₁ ∧ E₂) = P(E₁) × [P(E₁ ∧ E₂) / P(E₁)]
P(E₁ ∧ E₂ ∧ E₃) = P(E₁) × [P(E₁ ∧ E₂) / P(E₁)] × [P(E₁ ∧ E₂ ∧ E₃) / P(E₁ ∧ E₂)]
     P(E₂ | E₁) ≡ P(E₁ ∧ E₂) / P(E₁)
...
= (E ∧ F) ∨ (E ∧ ¬F)
  P(E)
= P(E ∧ F) + P(E ∧ ¬F) - P((E ∧ F) ∧ (E ∧ ¬F))
= P(E ∧ F) + P(E ∧ ¬F) - P(𝟘)
= P(E ∧ F) + P(E ∧ ¬F)
= P(E | F) × P(F) + P(E | ¬F) × P(¬F)

= P(E ∧ F ∧ (G ∨ ¬G)) + P(E | ¬F) × P(¬F)
= P((E ∧ F ∧ G) ∨ (E ∧ F ∧ ¬G)) + P(E | ¬F) × P(¬F)
= P(E ∧ F ∧ G) + P(E ∧ F ∧ ¬G) - P((E ∧ F ∧ G) ∧ (E ∧ F ∧ ¬G)) + P(E | ¬F) × P(¬F)
= P(E | F ∧ G) × P(F ∧ G) + P(E | F ∧ ¬G) × P(F ∧ ¬G) - P(𝟘) + P(E | ¬F) × P(¬F)
= P(E | F ∧ G) × P(F ∧ G) + P(E | F ∧ ¬G) × P(F ∧ ¬G) + P(E | ¬F) × P(¬F)
...
# 事件的独立性
事件之间的独立性，指一个事件的发生不影响另一个事件的发生。
事件E的条件概率P(E | F)与无条件概率P(E)的区别在于，事件F的发生改变了事件E发生的概率，也即事件F对事件E有影响。
如果事件E与事件F相互不影响，则P(E | F) = P(E)，事件E与事件F相互独立。
在许多实际问题中，两个事件的独立性大多是根据经验来判断的。

P(E₂ | E₁) = P(E₂) = P(E₁ ∧ E₂) / P(E₁)

事件E₁与E₂独立，P(E₁ ∧ E₂) = P(E₁) × P(E₂)
P(E₁ ∧ ¬E₂) = P(E₁ ∧ (E₁ ∧ ¬E₂))
