...
Revised:   2020-08-09 23:47:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
Resources:
---
...
8[上确界] [s ≡ sup{a}] ⇔ ∃s;∀a∈{a};∀o;[[a ≤ s] ∧ [[a ≤ o] → [s ≤ o]]]
9[下确界] [s ≡ sub{a}] ⇔ ∃s;∀a∈{a};∃e∈{a};[[s ≤ a] ∧ [[s < a] → [e < a]]]
0[下确界] [s ≡ sub{a}] ⇔ ∃s;∀a∈{a};∀o;[[s ≤ a] ∧ [[o ≤ a] → [o ≤ s]]]
参照二元谓词：
   s ≡ sup{a}
...
7⇔ ∃s;∀a∈{a};∃e∈{a};[[a ≤ s] ∧ [[a < s] → [a < e]]]
   s ≡ sup{a}
 ⇔ ∃s;[∀a∈{a};[a ≤ s] ∧ ∀o;[∀a∈{a};[[a ≤ o] → [s ≤ o]]]]
 ⇔ ∃s;∀o;[∀a∈{a};[a ≤ s] ∧ ∀a∈{a};[[a ≤ o] → [s ≤ o]]]
 ⇔ ∃s;∀o;∀a∈{a};[[a ≤ s] ∧ [[a ≤ o] → [s ≤ o]]]
...
[s ≡ sub{as}] ⇔ ∃s;∀a∈{as};∃e∈{as};[[a ≤ s] ∧ [[a < s] → [a < e]]]
```
