...
【第十九条】
1. 人人有权持有主张，不受干涉；
2. 人人有自由发表意见的权利，此项权利包括寻求、接收和传递各种消息和思想的自由，而不论国界，也不论口头的、书写的、印刷的、采取艺术形式的，或通过他所选择的任何其它媒介；
...
# 可选的法律适用原则
[从新原则/应溯及既往原则] 即新法律适用于审判既往的违法行为，新法律适用于审判往后的违法行为；
[从旧原则/不溯及既往原则] 即旧法律适用于审判既往的违法行为，新法律适用于审判往后的违法行为；
[从轻原则/相较取其轻原则] 即新旧法律均适用于审判既往的违法行为，但定罪量刑时采用较轻的法律；
[从新兼从轻原则] 即通常情况新法律适用于审判既往的违法行为，个别情况定罪量刑时采用较轻的法律；
[从旧兼从轻原则] 即通常情况旧法律适用于审判既往的违法行为，个别情况定罪量刑时采用较轻的法律；
```
