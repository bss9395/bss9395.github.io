...
|        谓词①        |        谓词②        |    复合谓词③    |      复合命题④      |      复合命题⑤      |      复合命题⑥      |      复合命题⑦      |    复合谓词⑧    |
| :-----------------: | :-----------------: | :-------------: | :-----------------: | :-----------------: | :-----------------: | :-----------------: | :-------------: |
| ∀x[Q(x)] / ∃x[Q(x)] | ∀x[P(x)] / ∃x[P(x)] | ∀x[Q(x) → P(x)] | ∃x[Q(x)] → ∀x[P(x)] | ∀x[Q(x)] → ∀x[P(x)] | ∃x[Q(x)] → ∃x[P(x)] | ∀x[Q(x)] → ∃x[P(x)] | ∃x[Q(x) → P(x)] |
|  {真, 真} 真 / 真   |  {真, 真} 真 / 真   |  真 ∧ 真 = 真   |    真 → 真 = 真     |    真 → 真 = 真     |    真 → 真 = 真     |    真 → 真 = 真     |  真 ∨ 真 = 真   |
|  {真, 真} 真 / 真   |  {真, 假} 假 / 真   |  真 ∧ 假 = 假   |    真 → 假 = 假     |    真 → 假 = 假     |    真 → 真 = 真     |    真 → 真 = 真     |  真 ∨ 假 = 真   |
|  {真, 真} 真 / 真   |  {假, 假} 假 / 假   |  假 ∧ 假 = 假   |    真 → 假 = 假     |    真 → 假 = 假     |    真 → 假 = 假     |    真 → 假 = 假     |  假 ∨ 假 = 假   |
|  {真, 假} 假 / 真   |  {真, 真} 真 / 真   |  真 ∧ 真 = 真   |    真 → 真 = 真     |    假 → 真 = 真     |    真 → 真 = 真     |    假 → 真 = 真     |  真 ∨ 真 = 真   |
|  {真, 假} 假 / 真   |  {真, 假} 假 / 真   |  真 ∧ 假 = 假   |    真 → 假 = 假     |    假 → 假 = 真     |    真 → 真 = 真     |    假 → 真 = 真     |  真 ∨ 假 = 真   |
|  {真, 假} 假 / 真   |  {假, 假} 假 / 假   |  真 ∧ 假 = 假   |    真 → 假 = 假     |    假 → 假 = 真     |    真 → 假 = 假     |    假 → 假 = 真     |  真 ∨ 假 = 真   |
|  {假, 假} 假 / 假   |  {真, 真} 真 / 真   |  真 ∧ 真 = 真   |    假 → 真 = 真     |    假 → 真 = 真     |    假 → 真 = 真     |    假 → 真 = 真     |  真 ∨ 真 = 真   |
|  {假, 假} 假 / 假   |  {真, 假} 假 / 真   |  真 ∧ 真 = 真   |    假 → 假 = 真     |    假 → 假 = 真     |    假 → 真 = 真     |    假 → 真 = 真     |  真 ∨ 真 = 真   |
|  {假, 假} 假 / 假   |  {假, 假} 假 / 假   |  真 ∧ 真 = 真   |    假 → 假 = 真     |    假 → 假 = 真     |    假 → 假 = 真     |    假 → 假 = 真     |  真 ∨ 真 = 真   |
|                     |                     |      ③ ⇔ ④      |        ④ ⇒ ⑤        |        ⑤ ⇒ ⑦        |        ⑥ ⇒ ⑦        |        ⑦ ⇔ ⑧        |                 |
|                     |                     |                 |        ④ ⇒ ⑥        |                     |                     |                     |                 |
...
∀x[Q(x)] ∧ ∀x[P(x)] ⇔ ∀x∀y[Q(x) ∧ P(y)] ⇔ ∀x[Q(x) ∧ P(x)]
∀x[Q(x)] ∨ ∀x[P(x)] ⇔ ∀x∀y[Q(x) ∨ P(y)] ⇒ ∀x[Q(x) ∨ P(x)]
∃x[Q(x)] ∨ ∃x[P(x)] ⇔ ∃x∃y[Q(x) ∨ P(y)] ⇔ ∃x[Q(x) ∨ P(x)]
∃x[Q(x)] ∧ ∃x[P(x)] ⇔ ∃x∃y[Q(x) ∧ P(y)] ⇐ ∃x[Q(x) ∧ P(x)]

∀x[Q(x) → P(x)] ⇔ ∃x[Q(x)] → ∀x[P(x)] ⇒ ∀x[Q(x)] → ∀x[P(x)] ⇒ ∀x[Q(x)] → ∃x[P(x)] ⇔ ∃x[Q(x) → P(x)]
∀x[Q(x) → P(x)] ⇔ ∃x[Q(x)] → ∀x[P(x)] ⇒ ∃x[Q(x)] → ∃x[P(x)] ⇒ ∀x[Q(x)] → ∃x[P(x)] ⇔ ∃x[Q(x) → P(x)]
