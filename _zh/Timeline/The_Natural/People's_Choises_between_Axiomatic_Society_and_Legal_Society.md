...
# 实数公理系统的公理，共15个
∀r∈ℝ; ∀s∈ℝ; ∀t∈ℝ; ∃0∈ℝ; ∃-r∈ℝ; ∃1∈ℝ; ∃r⁻¹≠0∈ℝ; ∀p∈P⊂ℝ; ∀q∈Q⊂ℝ; ∃pq∈ℝ;
## 加运算公理，共4个
[加法有零元]    { 0} + r = r
[加法有负元]    {-r} + r = 0
[加法结合律] (r + s) + t = r + (s + t)
...
根据公理证明：
 乘法有逆元 ⇒             (r × s)⁻¹ × (r × s) = 1
 满足恒等性 ⇒ s⁻¹ × r⁻¹ × (r × s)⁻¹ × (r × s) = s⁻¹ × r⁻¹ × 1
 乘法交换律 ⇒ s⁻¹ × r⁻¹ × (r × s) × (r × s)⁻¹ = 1 × s⁻¹ × r⁻¹
 乘法结合律 ⇒ s⁻¹ × [r⁻¹ × r] × s × (r × s)⁻¹ = 1 × s⁻¹ × r⁻¹
 乘法有逆元 ⇒         s⁻¹ × 1 × s × (r × s)⁻¹ = 1 × s⁻¹ × r⁻¹
 乘法有幺元 ⇒             s⁻¹ × s × (r × s)⁻¹ = s⁻¹ × r⁻¹
 乘法有逆元 ⇒                   1 × (r × s)⁻¹ = s⁻¹ × r⁻¹
 乘法有幺元 ⇒                       (r × s)⁻¹ = s⁻¹ × r⁻¹
...
于2020年08月04日 16:02:00 +08 在湛江 +08
