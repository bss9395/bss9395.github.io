...
Revised:   2020-07-21 00:17:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
Resources:
---
...
人类的语言能力具有丰富的含义，因此当人类通过自然语言进行思想交流的时候很容易产生歧义的结论，而通过逻辑语言进行推理论证的时候较容易得到严谨的结论。在逻辑学的研究中，命题逻辑是最基本的逻辑，所谓命题就是逻辑值非真即假的陈述语句，逻辑值为真的真命题即为有效命题，逻辑值为假的假命题即为无效命题，简单命题通过逻辑联结词可构成复合命题。根据人类在日常生活中的思维习惯，可提炼得到逻辑学中最常用的5个逻辑联结词，按优先级从高到低依次为[否定]/[合取]/[析取]/[蕴涵]/[等值]，其中[否定]/[合取]/[析取]这3个逻辑联结词是最基本的逻辑联结词，[蕴含]可通过[否定]/[析取]派生出来，[等值]又可通过[蕴含]派生出来。[蕴含]是比较特别的逻辑联结词，当前项命题为真时，其复合命题的逻辑值由后项命题决定，但当前项命题为假时，与人类在绝大多数情境下的思维习惯相一致，逻辑学中采用善意推断的原则，为满足复合命题的逻辑值为真，默认后向命题的逻辑值无关紧要，因此善意推断又称成真推断。在逻辑电路设计中，还有3个相当常用的逻辑联结词，按优先级从高到低依次为[与非]/[或非]/[异或]。人类在自然语言中相当容易产生歧义性的地方，就体现在[兼或]/[异或]这两种语义的微妙差别之中，当前项命题和后项命题同时为真时，在[兼或]语义下其复合命题的逻辑值为真，而在[异或]语义下其复合命题的逻辑值为假。以符号表示的形式可将自然语言翻译成逻辑语言，然而在通常的逻辑语言中，前项命题的逻辑值与后项命题的逻辑值彼此独立，复合命题的逻辑值仅表示其在逻辑语义下的真假，与其在自然语义下是否有意义无关。
...
| 逻辑值表 |      | 基本 |  基本  |  基本  |  常用  |       常用        |   电路   |   电路   |   电路   |
| :------: | :--: | :--: | :----: | :----: | :----: | :---------------: | :------: | :------: | :------: |
|          |      | 否定 |  合取  |  析取  |  蕴涵  |       等值        |   与非   |   或非   |   异或   |
|   命题   | 命题 | 非P  | P并且Q | P兼或Q | 若P则Q |      P仅当Q       | P与Q之非 | P或Q之非 | P不兼或Q |
|    P     |  Q   |  ¬P  | P ∧ Q  | P ∨ Q  | P → Q  |       P ↔ Q       |  P ↑ Q   |  P ↓ Q   |  P ⊕ Q   |
|    真    |  真  |  假  |   真   |   真   |   真   |        真         |    假    |    假    |    假    |
|    真    |  假  |  假  |   假   |   真   |   假   |        假         |    真    |    假    |    真    |
|    假    |  真  |  真  |   假   |   真   |   真   |        假         |    真    |    假    |    真    |
|    假    |  假  |  真  |   假   |   假   |   真   |        真         |    真    |    真    |    假    |
|   ¬¬P    |      |      | Q ∧ P  | Q ∨ P  | ¬P ∨ Q | (P → Q) ∧ (Q → P) | ¬(P ∧ Q) | ¬(P ∨ Q) | ¬(P ↔ Q) |
...
| 命题 | 命题 | 命题 | 命题 |           合取演绎            |           析取演绎            |           三段等价            |           三段演绎            |                二择前提                 |                  结论二难                   |
| :--: | :--: | :--: | :--: | :---------------------------: | :---------------------------: | :---------------------------: | :---------------------------: | :-------------------------------------: | :-----------------------------------------: |
...
```
# 命题逻辑的推理规则
[引入已知前提规则] 在命题逻辑推理的任何步骤，都可以引入已知前提。
[附加已得推论规则] 在命题逻辑推理的任何步骤，都可以附加已得推论。
...
[惩罚公理] 引发公众敌意对待，公众审判，惩罚，或者同态复仇。
```

公理：
法律：那些危害生命健康与人身自由，并引发公众敌意对待的行为就是犯罪，惩罚应依公众敌意对待之程度而作出。

宪法/法律/规矩/规范/风俗/公理/推论
...
言论自由，第一条修正案，国会不得制定有关下列事项的法律，确立一种宗教或禁止信教自由，剥夺言论自由或出版自由，剥夺人民和平集会及向政府要求伸冤的权利。
各级政府不得对言论和出版物进行事先限制/事先新闻检查，但可进行事后的新闻检查，追究责任并根据有关法律禁止已发表的言论和出版物的传播，并向法院起诉，达到限制言论自由的目的。
...
权力与责任，对公众而言  权利与义务，对个人而言
私权/权利/个人权利，涵盖一切不为法律明文禁止的个人行为。
公权/权力/公共权利，维护公益为目的的公共团体及其责任人在职务上的权力。
国家权力是公民让渡其全部自然权利而获得的，没有公民的权利，也就没有国家的权力。
1. 权力来源于权利；
2. 权力以保障权利为目的；
3. 权力以权利为界限；


宪法规定公民的基本权利与义务，法律规定公民的具体权利与义务。

法律的制定/修改/废止/认可，法律的生效/溯及/失效。

不同效力形式的规范性法律文件之间是有效力等级划分的。居于效力等级上位的被称为上位法；居于效力等级下位的，被称为下位法。上位法的效力优于下位法，即下位法与上位法相冲突时，以上位法为据不再适用下位法，简称为上位法优于下位法。至于下位法是否因此而被宣告无效的问题，应依照立法法和宪法的具体规定和相应程序加以解决。
对于同一效力等级中的规范性法律文件的效力原则。特别法的效力优先适用于一般法。
对于不同效力等级之间的规范性法律文件冲突，则应适用上位法优先适用于下位法的原则。

法律必须公开才有效力，否则就是专制而非法治。

法律的时间效力，生效/失效/溯及力，溯及既往的能力，指新的法律对其实施以前的行为或事项是否具有效力，如果心发对既往的行为或事项有法律效力，即为有溯及力，如果没有法律效力，即为无溯及力。

法律的空间效力， 领土/领水/领空
法律的对人效力，在领域范围内的自然人/法人/非法人组织。对身在外国的本国公民。
法律的对事效力，一事不再理，同一国家机关对同一事项已经作出处罚或者裁决，就不能再就同一事项进行受理或作出处理；
一事不二罚，指对同一行为不能受到两次及以上的处罚。在同一次处罚中可以处以两种以上的处罚，刑事处罚中的徒刑与剥夺政治权利或者罚金。

在英国，遵循前例原则就包括以下情形：上议院判决对其它一切法院均有约束力，上诉法院的判决对上议院以外的所有法院包括其自身都具有约束力，高等法院法官的判决，下级法院必须遵从。

行为能力，指法律关系主体能够依照自己的意志，通过自己的行为，依法取得权利和承担义务的能力。行为能力，一般都由各国根据一定的客观情况（年龄/智力）用法律加以具体规定。通常把作为自然人的本国公民依据行为能力划分为三类：
1. 完全行为能力，依法可以通过自己的行为，建立或参加法律关系，从而取得权利、承担义务的人。指各国智力状态正常的成年人。成年人的标准由各国法律明确规定。
2. 无行为能力，依法不能通过自己的行为建立或参加法律关系，从而取得权利/承担义务的人。一般是指未成年人中年龄相当小的部分，以及精神状态被确认为不正常的人，其范围由法律规定之，他们的民事权利的享有/民事义务的承担都由其代理人或监护人进行。
3. 限制行为能力，也就是能建立或参加部分法律关系，具有部分行为能力的人。在一些法律关系中，他们可以通过自己的行为享有权利/承担义务。这一般是指达到一定年龄，而又尚未成年的人。

民法，18周岁以上的公民是成年人，具有完全民事行为能力，16周岁以上不满18周岁的公民，以自己的劳动收入为主要生活来源，视为完全民事行为能力人。10周岁以上的未成年人是限制民事行为能力人，不满10周岁的未成年人是无民事行为能力的人。

法律权利，指法律关系主体依法所享有的权能和利益。
法律义务，指法律关系主体依照法律规定，所承担的必须作出或不作出某种行为的责任。
...
法律效力是法律的规范性拘束力，在效力范围上包括时间效力/空间效力/对象效力，特别法在效力位阶上要处理异位法之间和同位法之间的关系。法律关系是依法形成的规范性关系，其内容是权利与义务/权力与责任。

实体法规定人们日常社会生活中权利（权力）和义务（责任）的法律。
程序法是在诉讼或其它纠纷解决机制中保障上述权利（权力）和义务（责任）实现的法律。

法律溯及力，即法律溯及既往的效力，是指法律适用于其生效以前的事件和行为。如不适用，则法律便没有溯及力。
法律一般以不溯及既往为原则，这是由于法律溯及既往无异于以今天的法律要求昨天的行为，显属强人所难。
1. 从旧原则，法律一律不溯及既往，新法对其生效前的事件和行为一律不适用；
2. 从新原则，法律一律溯及既往，新法对其生效前的事件和行为一律适用。
3. 从旧从轻原则，法律原则上不溯及既往，但新法更有利于保护行为人的利益或新法对行为人的处罚轻于旧法时则适用新法。
4. 从新从轻原则，法律原则上不溯及既往，但旧法更有利于保护行为人的利益或对行为人的处罚轻于新法时则适用旧法。

处于同一效力位阶的法律是同位法，处于不同效力位阶的法律是异位法。
上位法优于下位法，根本法优于普通法，中央立法优于地方立法，同级立法中权力机关立法优于行政立法，同类立法中高层次立法优于低层次立法。
同一机关制定的法律是同位法，国务院下属不同部门制定的部门规章/部门规章与地方政府规章/地方性法规与部门规章不是同位法，他们不具备共同的制定机关，但彼此之间又不存在异位法关系，其效力高低无法直接比较。

特别法优于一般法仅就同位法而言，特别法优于一般法是指同一机关制定的法律中关于同一事项同时有特别规定和一般规定存在的，特别规定具有优先适用的效力。

新法优于旧法。新法优于旧法是指因法律修改而造成的新法/旧法对同一事项有不同的规定时，新法具有优先适用的效力。
...
实体法规定法律关系实体内容的法律，也即规定具体权利/义务/后果及其范围的法律。
民法规定着公民/法人之间在一定人身关系和财产关系中的权利/义务。
刑法规定者国家刑事惩罚权行使的条件与刑罚适用的范围。
程序法规定实体法律的方法与手续的法律。为实体法的实现服务的，是实体法得以实现的条件和保证。
程序法包括民事诉讼法/刑事诉讼法/行政诉讼法/仲裁法/立法程序法/行政程序法。
民事诉讼法是规定实现民事权利/义务的方法的法律，属于辅助民事实体法实施的程序法。
