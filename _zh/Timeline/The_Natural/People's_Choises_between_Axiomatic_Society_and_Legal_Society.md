...
Revised:   2020-07-16 00:05:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
Resources:
---
...
# 等价逻辑推理的形式结构
[从普遍推导出普遍] 从普遍有效的前提中发现同等普遍的有效推论。
(P1 → P2) ∧ …… ∧ (Pn → P1) ⇒ P1 ↔ Pn

# 演绎逻辑推理的形式结构
[从普遍推导出特殊] 从普遍有效的前提中发现相对特殊的有效推论。
(P1 → P2) ∧ …… ∧ (Pm → Pn) ⇒ P1 → Pn

# 归纳逻辑推理的形式结构
[从个性推导出共性] 从众多的个别事物中发现该类事物共有的特征。
  P(x1) ∧ P(x2) ∧ …… ∧ P(xn)
⇔ ∀x∈{x1, x2, ……, xn}[P(x)]
├ ∀x[P(x)]
...
逻辑推理有必然性逻辑推理与或然性逻辑推理之分，必然性逻辑推理即由有效的已知前提出发，根据推理规则推导出的结论必然有效，或然性逻辑推理即由有效的已知前提出发，根据推理规则推导出的结论或然有效，因此必然性推理又称有效推理，或然性推理又称合理推理。根据逻辑推理的方向是否可逆，必然性逻辑推理有等价逻辑推理与演绎逻辑推理之分，等价逻辑推理从普遍有效的前提中发现同等普遍的有效结论，演绎逻辑推理从普遍有效的前提中发现相对特殊的有效推论。根据逻辑推理的比较粒度大小，或然性逻辑推理有归纳逻辑推理与类比逻辑推理之分，归纳逻辑推理从众多的个别事物中发现该类事物共有的特征，类比逻辑推理从两类事物的对比中发现一类事物的缺失的特征。
