...
[无理数] 无限不循环小数不可以表示成分数形式。
圆周率定义为圆的周长与其直径之比值。
π ≈ 3.14159 26535 89793 23846 ⋯⋯

[实数] 实数的构造与实数采用何种进制没有关系。
假设实数的进制为β，所有β个数字分别为{¹α, ²α, ⋯⋯, ᵝα}。
比如实数的进制为7，所有7个数字分别为{1, 2, 3, 4, 5, 6, 7}。
...
[加法] 对于任意两个实数R₁与R₂的和，总是存在正整数n，使得满足关系式
  ¹A.¹α₁¹α₂⋯⋯¹αₙ ≤ ¹R < ¹A.¹α₁¹α₂⋯⋯¹αₙ + β⁻ⁿ
                    +
  ²A.²α₁²α₂⋯⋯²αₙ ≤ ²R < ²A.²α₁²α₂⋯⋯²αₙ + β⁻ⁿ
                    ǁ
³A.³α₁³α₂⋯⋯³αₙ₋₁ ≤ ³R < ³A.³α₁³α₂⋯⋯³αₙ₋₁ + β⁻⁽ⁿ⁻¹⁾

[乘法] 对于任意两个实数R₁与R₂的积，总是存在正整数n，使得满足关系式
  ¹A.¹α₁¹α₂⋯⋯¹αₙ ≤ ¹R < ¹A.¹α₁¹α₂⋯⋯¹αₙ + β⁻ⁿ
                    ×
  ²A.²α₁²α₂⋯⋯²αₙ ≤ ²R < ²A.²α₁²α₂⋯⋯²αₙ + β⁻ⁿ
                    ǁ
