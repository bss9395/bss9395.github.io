...
Revised:   2020-07-06 00:57:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
Resources:
---
...
|                              |           二元谓词①           |           二元谓词②           |           二元谓词③           |           二元谓词④           |           二元谓词⑤           |           二元谓词⑥           |
| :--------------------------: | :---------------------------: | :---------------------------: | :---------------------------: | :---------------------------: | :---------------------------: | :---------------------------: |
|           Q(x, y)            |         ∀y∀x[Q(x, y)]         |         ∀x∀y[Q(x, y)]         |         ∃y∀x[Q(x, y)]         |         ∀x∃y[Q(x, y)]         |         ∃x∃y[Q(x, y)]         |         ∃y∃x[Q(x, y)]         |
| {{x1y1, x1y2}, {x2y1, x2y2}} | (y1x1 ∧ y1x2) ∧ (y2x1 ∧ y2x2) | (x1y1 ∧ x1y2) ∧ (x2y1 ∧ x2y2) | (y1x1 ∧ y1x2) ∨ (y2x1 ∧ y2x2) | (x1y1 ∨ x1y2) ∧ (x2y1 ∨ x2y2) | (x1y1 ∨ x1y2) ∨ (x2y1 ∨ x2y2) | (y1x1 ∨ y1x2) ∨ (y2x1 ∨ y2x2) |
|     {{真, 真}, {真, 真}}     |              真               |  (真 ∧ 真) ∧ (真 ∧ 真) = 真   |  (真 ∧ 真) ∨ (真 ∧ 真) = 真   |  (真 ∨ 真) ∧ (真 ∨ 真) = 真   |  (真 ∨ 真) ∨ (真 ∨ 真) = 真   |              真               |
|     {{真, 真}, {真, 假}}     |              假               |  (真 ∧ 真) ∧ (真 ∧ 假) = 假   |  (真 ∧ 真) ∨ (真 ∧ 假) = 真   |  (真 ∨ 真) ∧ (真 ∨ 假) = 真   |  (真 ∨ 真) ∨ (真 ∨ 假) = 真   |              真               |
|     {{真, 真}, {假, 真}}     |              假               |  (真 ∧ 真) ∧ (假 ∧ 真) = 假   |  (真 ∧ 假) ∨ (真 ∧ 真) = 真   |  (真 ∨ 真) ∧ (假 ∨ 真) = 真   |  (真 ∨ 真) ∨ (假 ∨ 真) = 真   |              真               |
|     {{真, 真}, {假, 假}}     |              假               |  (真 ∧ 真) ∧ (假 ∧ 假) = 假   |  (真 ∧ 假) ∨ (真 ∧ 假) = 假   |  (真 ∨ 真) ∧ (假 ∨ 假) = 假   |  (真 ∨ 真) ∨ (假 ∨ 假) = 真   |              真               |
|     {{真, 假}, {真, 真}}     |              假               |  (真 ∧ 假) ∧ (真 ∧ 真) = 假   |  (真 ∧ 真) ∨ (假 ∧ 真) = 真   |  (真 ∨ 假) ∧ (真 ∨ 真) = 真   |  (真 ∨ 假) ∨ (真 ∨ 真) = 真   |              真               |
|     {{真, 假}, {真, 假}}     |              假               |  (真 ∧ 假) ∧ (真 ∧ 假) = 假   |  (真 ∧ 真) ∨ (假 ∧ 假) = 真   |  (真 ∨ 假) ∧ (真 ∨ 假) = 真   |  (真 ∨ 假) ∨ (真 ∨ 假) = 真   |              真               |
|     {{真, 假}, {假, 真}}     |              假               |  (真 ∧ 假) ∧ (假 ∧ 真) = 假   |  (真 ∧ 假) ∨ (假 ∧ 真) = 假   |  (真 ∨ 假) ∧ (假 ∨ 真) = 真   |  (真 ∨ 假) ∨ (假 ∨ 真) = 真   |              真               |
|     {{真, 假}, {假, 假}}     |              假               |  (真 ∧ 假) ∧ (假 ∧ 假) = 假   |  (真 ∧ 假) ∨ (假 ∧ 假) = 假   |  (真 ∨ 假) ∧ (假 ∨ 假) = 假   |  (真 ∨ 假) ∨ (假 ∨ 假) = 真   |              真               |
|     {{假, 真}, {真, 真}}     |              假               |  (假 ∧ 真) ∧ (真 ∧ 真) = 假   |  (假 ∧ 真) ∨ (真 ∧ 真) = 真   |  (假 ∨ 真) ∧ (真 ∨ 真) = 真   |  (假 ∨ 真) ∨ (真 ∨ 真) = 真   |              真               |
|     {{假, 真}, {真, 假}}     |              假               |  (假 ∧ 真) ∧ (真 ∧ 假) = 假   |  (假 ∧ 真) ∨ (真 ∧ 假) = 假   |  (假 ∨ 真) ∧ (真 ∨ 假) = 真   |  (假 ∨ 真) ∨ (真 ∨ 假) = 真   |              真               |
|     {{假, 真}, {假, 真}}     |              假               |  (假 ∧ 真) ∧ (假 ∧ 真) = 假   |  (假 ∧ 假) ∨ (真 ∧ 真) = 真   |  (假 ∨ 真) ∧ (假 ∨ 真) = 真   |  (假 ∨ 真) ∨ (假 ∨ 真) = 真   |              真               |
|     {{假, 真}, {假, 假}}     |              假               |  (假 ∧ 真) ∧ (假 ∧ 假) = 假   |  (假 ∧ 假) ∨ (真 ∧ 假) = 假   |  (假 ∨ 真) ∧ (假 ∨ 假) = 假   |  (假 ∨ 真) ∨ (假 ∨ 假) = 真   |              真               |
|     {{假, 假}, {真, 真}}     |              假               |  (假 ∧ 假) ∧ (真 ∧ 真) = 假   |  (假 ∧ 真) ∨ (假 ∧ 真) = 假   |  (假 ∨ 假) ∧ (真 ∨ 真) = 假   |  (假 ∨ 假) ∨ (真 ∨ 真) = 真   |              真               |
|     {{假, 假}, {真, 假}}     |              假               |  (假 ∧ 假) ∧ (真 ∧ 假) = 假   |  (假 ∧ 真) ∨ (假 ∧ 假) = 假   |  (假 ∨ 假) ∧ (真 ∨ 假) = 假   |  (假 ∨ 假) ∨ (真 ∨ 假) = 真   |              真               |
|     {{假, 假}, {假, 真}}     |              假               |  (假 ∧ 假) ∧ (假 ∧ 真) = 假   |  (假 ∧ 假) ∨ (假 ∧ 真) = 假   |  (假 ∨ 假) ∧ (假 ∨ 真) = 假   |  (假 ∨ 假) ∨ (假 ∨ 真) = 真   |              真               |
|     {{假, 假}, {假, 假}}     |              假               |  (假 ∧ 假) ∧ (假 ∧ 假) = 假   |  (假 ∧ 假) ∨ (假 ∧ 假) = 假   |  (假 ∨ 假) ∧ (假 ∨ 假) = 假   |  (假 ∨ 假) ∨ (假 ∨ 假) = 假   |              假               |
|                              |             ① ⇔ ②             |             ② ⇒ ③             |             ③ ⇒ ④             |             ④ ⇒ ⑤             |             ⑤ ⇔ ⑥             |                               |
