...
| 命题 | 命题 | 命题 | 命题 |           排挤障碍            |           合取演绎            |           析取演绎            |           三段等价            |           三段演绎            |                 归并演绎                  |                二择前提                 |                  结论二难                   |
| :--: | :--: | :--: | :--: | :---------------------------: | :---------------------------: | :---------------------------: | :---------------------------: | :---------------------------: | :---------------------------------------: | :-------------------------------------: | :-----------------------------------------: |
|  P   |  Q   |  R   |  S   | [P ∧ (Q ∨ R)] → [Q ∨ (P ∧ R)] | [(P ∧ Q) ∧ (Q → R)] → [P ∧ R] | [(P ∨ Q) ∧ (Q → R)] → [P ∨ R] | [(P ↔ Q) ∧ (Q ↔ R)] ↔ [P ↔ R] | [(P ↔ Q) ∧ (Q ↔ R)] → [P ↔ R] | [(P → Q) ∧ (R → S)] → [(P ∨ R) → (Q ∨ S)] | [(P ∨ R) ∧ (P → Q) ∧ (R → S)] → [Q ∨ S] | [(¬Q ∨ ¬S) ∧ (P → Q) ∧ (R → S)] → [¬P ∨ ¬R] |
...
|  真  |  假  |  真  |  真  |  [真 ∧ 真] → [假 ∨ 真] = 真   |      [假 ∧ 真] → 真 = 真      |      [真 ∧ 真] → 真 = 真      |      [假 ∧ 假] ↔ 真 = 假      |      [假 ∧ 假] → 真 = 真      |        [假 ∧ 真] → [真 → 真] = 真         |        [真 ∧ 假 ∧ 真] → 真 = 真         |          [真 ∧ 假 ∧ 真] → 假 = 真           |
|  真  |  假  |  假  |  真  |  [真 ∧ 假] → [假 ∨ 假] = 真   |      [假 ∧ 真] → 假 = 真      |      [真 ∧ 真] → 真 = 真      |      [假 ∧ 真] ↔ 假 = 真      |      [假 ∧ 真] → 假 = 真      |        [假 ∧ 真] → [真 → 真] = 真         |        [真 ∧ 假 ∧ 真] → 真 = 真         |          [真 ∧ 假 ∧ 真] → 真 = 真           |
|  假  |  真  |  真  |  真  |  [假 ∧ 真] → [真 ∨ 假] = 真   |      [假 ∧ 真] → 假 = 真      |      [真 ∧ 真] → 真 = 真      |      [假 ∧ 真] ↔ 假 = 真      |      [假 ∧ 真] → 假 = 真      |        [真 ∧ 真] → [真 → 真] = 真         |        [真 ∧ 真 ∧ 真] → 真 = 真         |          [假 ∧ 真 ∧ 真] → 真 = 真           |
|  假  |  真  |  假  |  真  |  [假 ∧ 真] → [真 ∨ 假] = 真   |      [假 ∧ 假] → 假 = 真      |      [真 ∧ 假] → 假 = 真      |      [假 ∧ 假] ↔ 真 = 假      |      [假 ∧ 假] → 真 = 真      |        [真 ∧ 真] → [假 → 真] = 真         |        [假 ∧ 真 ∧ 真] → 真 = 真         |          [假 ∧ 真 ∧ 真] → 真 = 真           |
|  假  |  假  |  真  |  真  |  [假 ∧ 真] → [假 ∨ 假] = 真   |      [假 ∧ 真] → 假 = 真      |      [假 ∧ 真] → 真 = 真      |      [真 ∧ 假] ↔ 假 = 真      |      [真 ∧ 假] → 假 = 真      |        [真 ∧ 真] → [真 → 真] = 真         |        [真 ∧ 真 ∧ 真] → 真 = 真         |          [真 ∧ 真 ∧ 真] → 真 = 真           |
|  假  |  假  |  假  |  真  |  [假 ∧ 假] → [假 ∨ 假] = 真   |      [假 ∧ 真] → 假 = 真      |      [假 ∧ 真] → 假 = 真      |      [真 ∧ 真] ↔ 真 = 真      |      [真 ∧ 真] → 真 = 真      |        [真 ∧ 真] → [假 → 真] = 真         |        [假 ∧ 真 ∧ 真] → 真 = 真         |          [真 ∧ 真 ∧ 真] → 真 = 真           |
...
于2020年08月08日 00:05:00 +08 在湛江 +08
