...
| 风控措施 | 签名+账户信息，盗刷由银行承担 | 签名+支付密码，盗刷由本人承担 |
| 消费习惯 | 透支消费，债务较多            | 预支消费，债务较少            |
| 结账系统 | 统一的银行间结账系统          | 分散的银行间结账系统          |
| 结账效率 | 延时结账（两到三个工作日）    | 实时结账（稍等片刻即完成）    |
| 银行柜台 | 人数较少，无需挂号排队        | 人数较多，需要挂号排队        |
