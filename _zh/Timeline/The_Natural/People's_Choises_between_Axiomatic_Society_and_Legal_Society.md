...
|  {假, 假} 假 / 假   |  {真, 真} 真 / 真   |     真 ∧ 真 = 真      |     假 → 真 = 真      |     假 → 真 = 真      |     假 → 真 = 真      |    假 → 假 = 真     |  真 ∨ 真 = 真   |
|  {假, 假} 假 / 假   |  {真, 假} 假 / 真   |     真 ∧ 真 = 真      |     假 → 真 = 真      |     假 → 假 = 真      |     假 → 真 = 真      |    假 → 假 = 真     |  真 ∨ 真 = 真   |
|  {假, 假} 假 / 假   |  {假, 假} 假 / 假   |     真 ∧ 真 = 真      |     假 → 真 = 真      |     假 → 假 = 真      |     假 → 假 = 真      |    假 → 假 = 真     |  真 ∨ 真 = 真   |
|                     |                     | ⇔ ∃x[Q(x)] → ∀x[P(x)] | ⇒ ∃x[Q(x)] → ∃x[P(x)] | ⇒ ∃x[Q(x)] → ∃x[P(x)] | ⇒ ∀x[Q(x)] → ∃x[P(x)] |  ⇔ ∃x[Q(x) → P(x)]  |                 |
