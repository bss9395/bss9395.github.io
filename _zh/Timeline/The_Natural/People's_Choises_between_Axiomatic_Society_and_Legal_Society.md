...
Revised:   2020-08-05 17:43:00 +08 @ 中国-广东-湛江 +08
Authors:   璀璨星辰
Resources:
---
...
2依化简前提 ⇒  [r < s] → [r ≤ s]
 ...
 满足可加性 ⇒  [r < s] → [r + t < s + t] ∨ [r = s]
 满足不等性 ⇒  [r < s] ↔ [[r ≤ s] ∧ [r ≠ s]]
 依化简前提 ⇒  [r < s] → [r ≠ s]
 引入结论法 ⇒  [r < s] → [[r + t < s + t] ∨ [r = s]] ∧ [r ≠ s]
3依排除矛盾 ⇒  [r < s] → [r + t < s + t]
 满足可加性 ⇒  [r + t < s + t] →   [r + t + -t < s + t + -t]
 加法结合律 ⇒  [r + t < s + t] → [r + (t + -t) < s + (t + -t)]
 加法有负元 ⇒  [r + t < s + t] →        [r + 0 < s + 0]
3加法有零元 ⇒  [r + t < s + t] → [r < s]
3根据双向律 ⇒  [r < s] ↔ [r + t < s + t]
 满足可加性 ⇒  [r < 0] ↔ [-r + r < -r + 0]
 加法有负元 ⇒  [r < 0] ↔ [0 < -r + 0]
...
根据公理证明：
 ...
 乘法交换律 ⇒ [r × s = 0] → [[r ≠ 0] → [s = 0 × r⁻¹]]
 乘法有零元 ⇒ [r × s = 0] → [[r ≠ 0] → [s = 0]]
1根据善意律 ⇒ [r × s = 0] → [[r = 0] ∨ [s = 0]]
 附加前提法 ⇒         [r = 0] ∨ [s = 0]
 满足恒等性 ⇒ [r × s = 0 × s] ∨ [r × s = r × 0]
 乘法交换律 ⇒ [r × s = 0 × s] ∨ [r × s = 0 × r]
 乘法有零元 ⇒     [r × s = 0] ∨ [r × s = 0]
1根据幂等律 ⇒     [r × s = 0]
1根据双向律 ⇒ [r × s = 0] ↔ [[r = 0] ∨ [s = 0]]

[矩阵乘法律] (r × s)⁻¹ = s⁻¹ × r⁻¹
根据公理证明：
 乘法有逆元 ⇒ [[r ≠ 0] ∧ [s ≠ 0]] →           (r × s)⁻¹ × (r × s) = 1
 满足恒等性 ⇒ [[r ≠ 0] ∧ [s ≠ 0]] → s⁻¹ × r⁻¹ × (r × s)⁻¹ × (r × s) = s⁻¹ × r⁻¹ × 1
 乘法交换律 ⇒ [[r ≠ 0] ∧ [s ≠ 0]] → s⁻¹ × r⁻¹ × (r × s) × (r × s)⁻¹ = 1 × s⁻¹ × r⁻¹
 乘法结合律 ⇒ [[r ≠ 0] ∧ [s ≠ 0]] → s⁻¹ × [r⁻¹ × r] × s × (r × s)⁻¹ = 1 × s⁻¹ × r⁻¹
 乘法有逆元 ⇒ [[r ≠ 0] ∧ [s ≠ 0]] →         s⁻¹ × 1 × s × (r × s)⁻¹ = 1 × s⁻¹ × r⁻¹
 乘法结合律 ⇒ [[r ≠ 0] ∧ [s ≠ 0]] →       s⁻¹ × [1 × s] × (r × s)⁻¹ = 1 × s⁻¹ × r⁻¹
...
根据公理证明：
 附加前提法 ⇒       [r < 0] ∧ [s < 0]
 根据负负性 ⇒      [0 < -r] ∧ [0 < -s]
 根据不等性 ⇒      [0 ≤ -r] ∧ ¬[-r = 0] ∧  [0 ≤ -s] ∧ ¬[-s = 0]
 根据交换律 ⇒      [0 ≤ -r] ∧  [0 ≤ -s] ∧ ¬[-r = 0] ∧ ¬[-s = 0]
 根据可乘性 ⇒         [0 ≤ (-r) × (-s)] ∧ ¬[-r = 0] ∧ ¬[-s = 0]
 乘法交换律 ⇒ [0 ≤ (-1) × (-1) × r × s] ∧ ¬[-r = 0] ∧ ¬[-s = 0]
 乘法有逆元 ⇒           [0 ≤ 1 × r × s] ∧ ¬[-r = 0] ∧ ¬[-s = 0]
 乘法有幺元 ⇒               [0 ≤ r × s] ∧ ¬[-r = 0] ∧ ¬[-s = 0]
 满足恒等性 ⇒               [0 ≤ r × s] ∧ ¬[(-1) × -r = (-1) × 0] ∧ ¬[(-1) × s = (-1) × 0]
 加法负运算 ⇒               [0 ≤ r × s] ∧ ¬[r = (-1) × 0] ∧ ¬[s = (-1) × 0]
 乘法交换律 ⇒               [0 ≤ r × s] ∧ ¬[r = 0 × (-1)] ∧ ¬[s = 0 × (-1)]
 乘法有零元 ⇒               [0 ≤ r × s] ∧ ¬[r = 0] ∧ ¬[s = 0]
 根据置否律 ⇒               [0 ≤ r × s] ∧ ¬[[r = 0] ∨ [s = 0]]
 乘法零元律 ⇒               [0 ≤ r × s] ∧ ¬[r × s = 0]
7满足不等性 ⇒               [0 < r × s]
